spool nikira-DML-rule-reject-future-records-recharge-exec.log
set feedback off ;
...
insert into expressions(id, left_field, right_field, right_field_indicator, operator_id) values(expressions_seq.nextval,'1','1 days from now', 1035, 16);
