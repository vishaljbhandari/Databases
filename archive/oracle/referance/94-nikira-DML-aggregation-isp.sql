...
-- Archive Map ----
insert into archive_maps(ID, ARCHIVE_NAME, LOOKUP_TABLE_NAME, RECORD_CONFIG_ID) values(9, 'ARCHIVED_ALARM_IPDR', 'ARCHIVED_ALARM_IPDR', 83);
...
insert into counter_manager_mappings (counter_detail_id, counter_type_id, aggregation_type_id, record_config_id) values (1, 6, 225, 83) ;
...
insert into counter_manager_mappings (counter_detail_id, counter_type_id, aggregation_type_id, record_config_id) values (4, 11, 16, 83) ;
...
INSERT INTO counter_maps (category, aggregation_type, function_id, record_config_id, id, counter_type) values ('REGULAR', 16, 24, 83, counter_maps_seq.nextval, 11) ;
INSERT INTO counter_maps (category, aggregation_type, function_id, record_config_id, id, counter_type) values ('REGULAR', 16, 25, 83, counter_maps_seq.nextval, 11) ;
