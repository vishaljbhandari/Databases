...
insert into rc_record_configs (select rc_record_configs_seq.nextval, 83, id, 'RULE' from tasks where name = 'IPDR Rule Creation') ;
insert into rc_record_configs (select rc_record_configs_seq.nextval, 83, id, 'TEMPLATE' from tasks where name = 'IPDR Template Creation') ;
