...
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter, category, is_partitioned) values(70, 'INTERNAL_USERS', 'Internal Users', 0, NULL, 1, ',', 'RULE_TAGS NAMED_FILTERS FINGERPRINT_RULE_ENTITY_TYPE', 0) ;

-- Adjustment Log Record
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter, category, is_partitioned) values(71, 'ADJUSTMENT_LOGS', 'Adjustment Logs', 0, NULL, 1, ',', 'RULE_TAGS FINGERPRINT_ENTITY NAMED_FILTERS TEST_RULE', 0) ;

-- CRM Log Record
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter, category, is_partitioned) values(72, 'CRM_LOGS', 'CRM Logs', 0, NULL, 1, ',', 'RULE_TAGS FINGERPRINT_ENTITY NAMED_FILTERS TEST_RULE', 0) ;
...
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_visible, is_cell_specific, is_pagination_enabled, is_primary_view, is_logging_enabled, create_manual_alarm,help_file_key, fetch_record) values(84, 'Adjustment Logs', 71, NULL, 'ID DESC', 1, 0, 1, 1, 1, 1,'ADJUSTMENT_LOGS_RECORD_VIEW',0) ;

-- CRM Logs record view
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_visible, is_cell_specific, is_pagination_enabled, is_primary_view, is_logging_enabled, create_manual_alarm,help_file_key, fetch_record) values(85, 'CRM Logs', 72, NULL, 'ID DESC', 1, 0, 1, 1, 1, 1,'CRM_LOGS_RECORD_VIEW',0) ;

-- Entries for Rule Creation enabled Record Configs --
insert into rule_creation_record_configs (select rc_record_configs_seq.nextval, 72, id, 'RULE' from tasks where name = 'CRM Logs Rule Creation') ;
insert into rule_creation_record_configs (select rc_record_configs_seq.nextval, 71, id, 'RULE' from tasks where name = 'Adjustment Logs Rule Creation') ;
insert into rule_creation_record_configs (select rc_record_configs_seq.nextval, 72, id, 'TEMPLATE' from tasks where name = 'CRM Logs Template Creation') ;
insert into rule_creation_record_configs (select rc_record_configs_seq.nextval, 71, id, 'TEMPLATE' from tasks where name = 'Adjustment Logs Template Creation') ;
...
-- Archive Map ----
insert into archive_maps(ID, ARCHIVE_NAME, LOOKUP_TABLE_NAME, RECORD_CONFIG_ID) values(5, 'ARCHIVED_ALARM_ADJUSTMENT_LOGS', 'ARCHIVED_ALARM_ADJUSTMENT_LOGS', 71);
insert into archive_maps(ID, ARCHIVE_NAME, LOOKUP_TABLE_NAME, RECORD_CONFIG_ID) values(6, 'ARCHIVED_ALARM_CRM_LOGS', 'ARCHIVED_ALARM_CRM_LOGS', 72);
...
insert into field_configs(id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width,reg_exp_id, associated_field, derivative_function, live_tree_ds) values (field_configs_seq.nextval, 70, 'Network', 'NETWORK_ID', 12, 0, 1, NULL, 1, NULL, 12, NULL, 10, 0, 20, NULL, NULL, NULL, NULL);

insert into field_configs(id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width,reg_exp_id, associated_field, derivative_function, live_tree_ds) values (field_configs_seq.nextval, 70, 'User Type', 'USER_TYPE', 13, 0, 1, NULL, 1, NULL, 13, NULL, NULL, 1, 20, NULL, NULL, NULL, NULL);

insert into field_configs(id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width,reg_exp_id, associated_field, derivative_function, live_tree_ds) values (field_configs_seq.nextval, 70, 'Privilige Class', 'PRIVILIGE_CLASS', 14, 0, 1, NULL, 1, NULL, 14, NULL, NULL, 1, 20, NULL, NULL, NULL, NULL);
...
insert into field_configs(id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width,reg_exp_id, associated_field, derivative_function, live_tree_ds) values (field_configs_seq.nextval, 71, 'Network', 'NETWORK_ID', 9, 0, 1, NULL, 1, NULL, 9, NULL, 10, 0, 20, NULL, NULL, NULL, NULL);
...
insert into field_configs(id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width,reg_exp_id, associated_field, derivative_function, live_tree_ds) values (field_configs_seq.nextval, 72, 'Network', 'NETWORK_ID', 5, 0, 1, NULL, 1, NULL, 5, NULL, 10, 0, 20, NULL, NULL, NULL, NULL);
...
insert into field_categories(id, name, category, data_type) values(221, 'Internal ID','PROFILE_AGG_TYPE FINGERPRINT_RULE_AGG_TYPE', 3) ;
insert into field_categories(id, name, category, data_type) values(219, 'Profiled Internal User ID', '', 1) ;
insert into field_categories(id, name, category, data_type, regular_expression_id, common_category_id) values(213, 'Internal User ID', 'AGGREGATION_TYPE HOTLIST MANUAL_ALARM NICKNAME', 3, 2, 213);
insert into field_categories(id, name, category, data_type, regular_expression_id, common_category_id) values(214, 'Employee Code', 'PROFILE_SPECIFIC AGGREGATION_TYPE MANUAL_ALARM NICKNAME HOTLIST', 3, 2, 214);


-- Modulo Dispatcher Categories ----
insert into modulo_dispatcher_categories  (record_config_id, field_category_id) values (70,213) ;
insert into modulo_dispatcher_categories  (record_config_id, field_category_id) values (71,213) ;
insert into modulo_dispatcher_categories  (record_config_id, field_category_id) values (72,213) ;
...
insert into record_loader_configurations(id, record_config_id) values (5, 70 ) ;
-- Adjustment Log
...
insert into record_loader_configurations(id, record_config_id) values (6, 71 ) ;
-- CRM Log
...
insert into record_loader_configurations(id, record_config_id) values (7, 72 ) ;
...
insert into aggregation_types_maps (id, source_aggregation, dest_aggregation, field_category_id, group_record_config_id) VALUES (aggre_types_map_seq.nextval, 213, 0, 0, 70) ;
insert into aggregation_types_maps (id, source_aggregation, dest_aggregation, field_category_id, group_record_config_id) VALUES (aggre_types_map_seq.nextval, 214, 0, 0, 70) ;
insert into aggregation_types_maps (id, source_aggregation, dest_aggregation, field_category_id, group_record_config_id) VALUES (aggre_types_map_seq.nextval, 221, 213,0,70) ;
...
insert into counter_maps(id, aggregation_type, record_config_id, function_id, counter_type)
                        (select counter_maps_seq.nextval,field_categories.id,record_configs.id,functions.id,1
                            from field_categories,functions,record_configs
                             ...
                             and functions.id not in (4,5,7,15,14,17,24, 25, 27)
                             and record_configs.tname in ('ADJUSTMENT_LOGS', 'CRM_LOGS')) ;

-- Profile Counter - Internal User
insert into counter_maps(id, aggregation_type, record_config_id, function_id, counter_type)
	(select counter_maps_seq.nextval, 221, record_configs.id, functions.id, 11 
...
insert into counter_manager_mappings (counter_detail_id, counter_type_id, aggregation_type_id, record_config_id)
	select 4, 11, 221, id from record_configs where id in (70, 71, 72) ; 
...
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_map_seq.nextval, 221, 71, '13') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_map_seq.nextval, 221, 72, '9') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_map_seq.nextval, 221, 70, '1') ;

-- Internal User
--Entries for Profile Counter
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (field_record_config_map_seq.nextval, 221, 51, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (field_record_config_map_seq.nextval, 219, 51, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (field_record_config_map_seq.nextval, 217, 51, '1') ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 5, 70, '12') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 213, 70, '17') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 216, 70, '140.1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 217, 70, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 219, 70, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 214, 70, '5') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 13, 70, '11') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 1, 70, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 183, 70, '6') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 184, 70, '7') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 185, 70, '9') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 186, 70, '8') ;
-- Phone Number
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (field_record_config_map_seq.nextval, 2, 70, '15') ;

-- Adjustment Log
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 13, 71, '4') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 2, 71, '3') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 213, 71, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 219, 71, '241.1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 214, 71, '10') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 5, 71, '9') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 1, 71, '11') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 17, 71, '5') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 217, 71, '241.1') ;

--Adjustment Logs Mapping with subscriber
insert into field_record_config_maps(ID,FIELD_CATEGORY_ID,RECORD_CONFIG_ID,FIELD_ASSOCIATION) 
	values(field_record_config_map_seq.nextval,16,71,'243.32') ;
insert into field_record_config_maps(ID,FIELD_CATEGORY_ID,RECORD_CONFIG_ID,FIELD_ASSOCIATION) 
	values(field_record_config_map_seq.nextval,29,71,'243.22') ;

-- CRM Log
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 13, 72, '2') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 213, 72, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 219, 72, '242.1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 5, 72, '5') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 1, 72, '7') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 214, 72, '6') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (field_record_config_map_seq.nextval, 217, 72, '242.1') ;
...
-- Adjustment Log --
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(BASIC_FILTER_SEQ.nextval, 71, 84, 1, 0, 1, 0) ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(BASIC_FILTER_SEQ.nextval, 71, 84, 2, 0, 2, 0) ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(BASIC_FILTER_SEQ.nextval, 71, 84, 3, 0, 3, 0) ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory, min, max) values(BASIC_FILTER_SEQ.nextval, 71, 84, 4, 10, 4, 0, '01-01-1970', '31-12-9999') ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory, min, max) values(BASIC_FILTER_SEQ.nextval, 71, 84, 5, 10, 5, 0, 0, 32767) ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(BASIC_FILTER_SEQ.nextval, 71, 84, 6, 0, 6, 0) ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(BASIC_FILTER_SEQ.nextval, 71, 84, 7, 0, 7, 0) ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(BASIC_FILTER_SEQ.nextval, 71, 84, 8, 0, 8, 0) ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(BASIC_FILTER_SEQ.nextval, 71, 84, 10, 0, 9, 0) ;

-- CRM Logs ---
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(BASIC_FILTER_SEQ.nextval, 72, 85, 1, 0, 1, 0) ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory, min, max) values(BASIC_FILTER_SEQ.nextval, 72, 85, 2, 10, 2, 0, '01-01-1970', '31-12-9999') ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(BASIC_FILTER_SEQ.nextval, 72, 85, 3, 0, 3, 0) ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(BASIC_FILTER_SEQ.nextval, 72, 85, 4, 0, 4, 0) ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(BASIC_FILTER_SEQ.nextval, 72, 85, 6, 0, 6, 0) ;
...
insert into dac_record_views_tasks (select dac_record_views_tasks_seq.nextval, 85, id from tasks where link like '%/record_view/list/85%') ;
insert into dac_record_views_tasks (select dac_record_views_tasks_seq.nextval, 84, id from tasks where link like '%/record_view/list/84%') ;
