...
--Internal User View
insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) values (tasks_seq.nextval, '0,2,4', GetParentID('Internal User View'), 'Internal User', '/record_view/list/83', 0, 1) ;
...
BEGIN
	...
	insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) values (tasks_seq.nextval, '0,2,4', parentid, 'Adjustment Logs', '/record_view/list/84', 0, 1) ;
	
	insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) values (tasks_seq.nextval, '0,2,4', parentid, 'CRM Logs', '/record_view/list/85', 0, 1) ;
