...
insert into report_parameters(id,report_id,position,name,report_parameter_name,report_data_type_id,translation_index_id,is_mandatory,regexp_id, units_to_display) values(REPORT_PARAMETERS_SEQ.nextval,reports_seq.currval,4,'Total Value','TotalValue',1,NULL,1,13, 'INR');
...
insert into report_parameters(id,report_id,position,name,report_parameter_name,report_data_type_id,translation_index_id,is_mandatory,regexp_id,units_to_display) values(REPORT_PARAMETERS_SEQ.nextval,reports_seq.currval,4,'Total Value','total_value',1,NULL,1,13,'INR');
