...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (271, 'Active/Blacklist Account Details', 3, 'ACCOUNT_ID', 103, 'ID', 0, 1, 'RULE');
