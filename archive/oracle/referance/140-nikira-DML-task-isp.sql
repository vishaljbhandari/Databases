...
---ISP
insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM) values (tasks_seq.nextval, '0,4', GetParentID('Record View'), 'IPDR', '/record_view/list/104', 0, 1) ;
...
insert into dac_record_views_tasks (select dac_record_views_tasks_seq.nextval, 104, id from tasks where link like '%record_view/list/104%') ;
commit ;
