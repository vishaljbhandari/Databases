...
insert into rule_creation_record_configs (select rc_record_configs_seq.nextval, 9901, id, 'CUST_ALERT_RULE' from tasks where name = 'New DataStream Customer Alert Rule Creation') ;
