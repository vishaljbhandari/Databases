...
insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM, IMAGE_SRC ) values (16, '0,1,2', GetParentID('Tasks'), 'eFingerprint Management','',0, 1, 'icons/fingerprintmanagement.png') ;
...
insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) values (tasks_seq.nextval, '0,1,2', GetParentID('eFingerprint Management'), 'eFingerprint Elements','', 0, 1) ;
insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) values (tasks_seq.nextval, '0,1,2', GetParentID('eFingerprint Management'), 'eFingerprint Configuration','', 0, 1) ;

-- eFingerprint Elements - Subscriber

insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) values (tasks_seq.nextval, '0,1', GetParentID('eFingerprint Elements', 'eFingerprint Management'), 'Subscriber', '/fp_element/index/54', 0, 1) ;
insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) values (tasks_seq.nextval, '0,1', GetParentID('Subscriber', 'eFingerprint Elements', 'eFingerprint Management'), 'Add', '/fp_element/new/54', 0, 0) ;
insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) values (tasks_seq.nextval, '0,1', GetParentID('Subscriber', 'eFingerprint Elements', 'eFingerprint Management'), 'Modify', '/fp_element/edit', 0, 0) ;
insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) values (tasks_seq.nextval, '0,1', GetParentID('Subscriber', 'eFingerprint Elements', 'eFingerprint Management'), 'Delete', '/fp_element/destroy;/fp_element/multiple_delete/54', 0, 0) ;
insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) values (tasks_seq.nextval, '0,1', GetParentID('Subscriber', 'eFingerprint Elements', 'eFingerprint Management'), 'Show', '/fp_element/show/54', 0, 0) ;





	insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) (select tasks_seq.nextval, '0,1', ( select id from tasks where instr(link, '/account/index/'||record_view_configs.id) = 1), 'View eFingerprint Profile', '/fp_profile/show_fp_profile/'||id ,0 ,0 from record_view_configs where id in(3,12,105)) ;
	...
	insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) (select tasks_seq.nextval, '0,1', ( select id from tasks where instr(link,'/account/index/'||record_view_configs.id) = 1), 'Manual Profile Match', '/fingerprint_rule/manual_profile_match/'||id ,0 ,0 from record_view_configs where id in(3,12)) ;
	...
	insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) values (tasks_seq.nextval, '0,1', GetParentID('eFingerprint Configuration', 'eFingerprint Management'), 'Subscriber', '/fp_configuration/show/16', 0, 1) ;
