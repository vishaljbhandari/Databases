...
/
	...
	insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) values (tasks_seq.nextval, '0,1,4', GetParentID('GPRS', 'Record View'), 'Filter on Non Indexed Fields', '/non_index_filtering/7', 0, 0) ;

	insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) values (tasks_seq.nextval, '0,1,4', GetParentID('GPRS', 'Record View'), 'Filter using LIKE Operator', '/filter_using_like_operator/7', 0, 0) ; 
