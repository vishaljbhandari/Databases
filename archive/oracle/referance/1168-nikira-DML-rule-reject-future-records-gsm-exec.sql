spool nikira-DML-rule-reject-future-records-gsm-exec.log
set feedback off ;
...
insert into expressions(id, left_field, right_field, right_field_indicator, operator_id) values(expressions_seq.nextval,'8','1 days from now', 1035, 16);
...
insert into record_configs_rules(rule_id, record_config_id) values((select id from rules where name = 'Rule For Future Record Rejection'), 1) ;
commit ;
