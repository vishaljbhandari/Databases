...
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter, category, is_partitioned, is_cost_computation_enabled) values(1,'CDR','CDR',1,'PHONE_NUMBER',1, ',', 'NAMED_FILTERS RULE_TAGS FINGERPRINT_ENTITY PROFILE_FIELD TEST_RULE', 1, 1) ;

-- Archive Map ----
insert into archive_maps( ID,ARCHIVE_NAME,LOOKUP_TABLE_NAME,RECORD_CONFIG_ID) values(1,'ARCHIVED_ALARM_CDR','ARCHIVED_ALARM_CDR',1);

-- Alarm XDR map ---
insert into alarm_xdr_maps( ID,LOOKUP_TABLE_NAME,RECORD_CONFIG_ID) values(alarm_xdr_maps_seq.nextval,'ALARM_CDR',1);

-- Record Views
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible, is_primary_view, is_logging_enabled, create_manual_alarm, is_advanced_query_enabled,help_file_key,fetch_record) values(1,'CDR',1,'','ID DESC', 1, 1, 1, 1, 1, 1,'CDR_RECORD_VIEW', 0) ;
...
insert into field_configs (id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter, reg_exp_id, derivative_function)  values (89, 1, 'OtherPartyNumber', '', 26, 0,3, 0, '', '',  32,null, 0,0,1, '11') ;
...
insert into field_configs (id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter, reg_exp_id, derivative_function)  values (94, 1, 'OtherPartyCountryCode', 'OTHER_PARTY_COUNTRY_CODE', 29, 0,3, 0, '', '',  20, 41, 1,1,'', '22') ;
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (251, 'Subscriber Details', 1, 'PHONE_NUMBER,SUBSCRIBER_ID', 102, 'PHONE_NUMBER,ID', 0, 2, 'RULE');
...
insert into expandable_field_maps(ID,NAME,SOURCE_VIEW_ID,SOURCE_KEY,DEST_VIEW_ID,DEST_KEY,DEST_KEY_TYPE,IS_NEW_VIEW,CATEGORY,DATA_RECORD_TYPE) values (expandable_field_maps_seq.nextval,'Caller Black List Subscriber Details',1,'CALLER_NUMBER',12,'PHONE_NUMBER',2,0,'RECORD_VIEW GR RULE',0);
insert into expandable_field_maps(ID,NAME,SOURCE_VIEW_ID,SOURCE_KEY,DEST_VIEW_ID,DEST_KEY,DEST_KEY_TYPE,IS_NEW_VIEW,CATEGORY,DATA_RECORD_TYPE) values (expandable_field_maps_seq.nextval,'Called Black List Subscriber Details',1,'CALLED_NUMBER',12,'PHONE_NUMBER',2,0,'RECORD_VIEW GR RULE',0);
...
------ For CDR Record View
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (expandable_field_maps_seq.nextval , 'Called Disconnected Subscriber Details', 1, 'CALLED_NUMBER',105, 'PHONE_NUMBER', 0, 2, 'RECORD_VIEW GR RULE') ;
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (expandable_field_maps_seq.nextval , 'Caller Disconnected Subscriber Details', 1, 'CALLER_NUMBER',105, 'PHONE_NUMBER', 0, 2, 'RECORD_VIEW GR RULE') ;
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (expandable_field_maps_seq.nextval , 'Disconnected Subscriber Details', 1, 'PHONE_NUMBER',105, 'PHONE_NUMBER', 0, 2, 'RECORD_VIEW GR RULE') ;
