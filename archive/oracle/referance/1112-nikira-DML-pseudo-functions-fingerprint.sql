...
insert into pseudo_functions (id, name, category, accumulation_function_id, accumulation_field_id) values (33, 'Profile Cumulative Download DataVolume', 'FP_ELEMENT', 24, 49) ;
