...
insert into translations(id, tr_id, key, value) values (translations_seq.nextval, 545, '-176', 'select id as Key, description as Value from record_configs where is_visible = 1 and id in (select record_config_id from fp_entities where category <> ''FP_ONLY'') order by description' ) ;
...
-- Statistical Rules
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible, is_cell_specific, is_primary_view,is_logging_enabled) values(94,'Statistical Rules',91,'IS_ACTIVE = 1','KEY ASC', 1, 0,0, 1, 1) ;
...
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, translation_id,is_filter) values (field_configs_seq.nextval, 91, 'Function', 'FUNCTION', 5, 1, 1, 7, 66,0) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, translation_id, is_filter) values (field_configs_seq.nextval, 91, 'Network', 'NETWORK_ID', 6, 0, 7, 11, 10, 0) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter, width, reg_exp_id,translation_id) values (field_configs_seq.nextval, 91, 'Status', 'STATUS', 7, 1, 3, 8, 1, 41, 10, 105) ; 
...
--Entries for Rules
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,  5, 91, '11') ;
...
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, translation_id) values (field_configs_seq.nextval, 79, 'Time Window', 'TIME_WINDOW', 5, 0, 1, 6, 9) ; 
