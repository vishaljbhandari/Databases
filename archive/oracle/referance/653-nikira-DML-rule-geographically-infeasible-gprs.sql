...
spool nikira-DML-rule-geographically-infeasible-gprs.log
set feedback off ;
set serveroutput off ;

---Geographically Infeasible - GPRS Rule -----------------------------
DECLARE
	...
	BEGIN
		...
		if (is_gsm_selected = 1 or is_cdma_selected = 1) then
			INSERT INTO rules(ID,PARENT_ID,KEY,NAME,VERSION,AGGREGATION_TYPE,ACCUMULATION_FIELD,ACCUMULATION_FUNCTION,PSEUDO_FUNCTION_ID,IS_ENABLED,CREATED_TIME,MODIFICATION_TIME,SEVERITY,USER_ID,DESCRIPTION,PROCESSOR_TYPE,CATEGORY,IS_ACTIVE) VALUES (rules_seq.nextval,'999',rules_key_seq.nextval,'Geographically Infeasible - GPRS','0','2','45','4','9','0',TO_DATE('2007-01-04 11:07:39','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2007-01-04 11:07:39','YYYY-MM-DD HH24:MI:SS'),'100','system',NULL,'1',null,'1') ;
