...
insert into alarm_status_action_maps (id, status, analyst_action_id, reference_type) values(29, 2, 33, 5) ;
...
insert into agg_type_pseudo_functions (id, aggregation_type_id, pseudo_function_id) (select agg_type_pseudo_functions_seq.nextval, 200, id from pseudo_functions where id = 36);
...
insert into agg_type_pseudo_functions (id, aggregation_type_id, pseudo_function_id) (select agg_type_pseudo_functions_seq.nextval, 200, id from pseudo_functions where id = 16);
insert into agg_type_pseudo_functions (id, aggregation_type_id, pseudo_function_id) (select agg_type_pseudo_functions_seq.nextval, 200, id from pseudo_functions where id = 17);
