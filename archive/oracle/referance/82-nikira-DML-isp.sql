...
insert into modulo_dispatcher_categories  (record_config_id, field_category_id) values (83,2) ;
...
insert into ds_granularity_maps(id, record_config_id, threshold_in_seconds, granularity_in_seconds) values (7,  83, 10 * 86400, 6 * 3600) ;
...
insert into scheduler_command_maps (job_name, command, is_parameter_required, is_network_based) values ('IPDR Session Summary', 'ipdrsessionsummary.rb,IPDRSessionSummaryPid', 0, (select decode(count(*), 1,0,1) from networks)) ;
