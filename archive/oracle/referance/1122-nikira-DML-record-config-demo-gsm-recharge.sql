...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (1, 'Recharge View', 1, 'CALLED_NUMBER', 2, 'PHONE_NUMBER', 1, 2, 'RECORD_VIEW GR');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (2, 'Recharge Details', 1, 'CALLER_NUMBER', 2, 'PHONE_NUMBER', 1, 2, 'RECORD_VIEW GR');
