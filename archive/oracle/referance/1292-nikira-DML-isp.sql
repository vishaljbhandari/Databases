...
insert into record_loader_config(id, record_config_id) values (4, 83 ) ;

--- Entries For IPDR View -------

insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(basic_filter_configs_seq.nextval, 83, 104, 4, 0, 1, 0) ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(basic_filter_configs_seq.nextval, 83, 104, 12, 0, 2, 0 ) ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory, min, max) values(basic_filter_configs_seq.nextval, 83, 104, 2, 10, 3, 0, '01-01-1970', '31-12-9999') ;
insert into basic_filter_configs (id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory, min, max, translation_id) values (basic_filter_configs_seq.nextval, 83, 104, 22, 8, 15, 0, '', '', 720 ) ;
