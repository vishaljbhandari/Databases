...
insert into field_record_config_maps(ID,FIELD_CATEGORY_ID,RECORD_CONFIG_ID,FIELD_ASSOCIATION) 
	values(FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,3000,10, expandable_field_maps_seq.currval || '.2');
insert into field_record_config_maps(ID,FIELD_CATEGORY_ID,RECORD_CONFIG_ID,FIELD_ASSOCIATION) 
	values(FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,3001,10, expandable_field_maps_seq.currval || '.3');
insert into field_record_config_maps(ID,FIELD_CATEGORY_ID,RECORD_CONFIG_ID,FIELD_ASSOCIATION) 
	values(FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,3002,10, expandable_field_maps_seq.currval || '.4');
insert into field_record_config_maps(ID,FIELD_CATEGORY_ID,RECORD_CONFIG_ID,FIELD_ASSOCIATION) 
	values(FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,3003,10, expandable_field_maps_seq.currval || '.5');
insert into field_record_config_maps(ID,FIELD_CATEGORY_ID,RECORD_CONFIG_ID,FIELD_ASSOCIATION) 
	values(FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,3004,10, expandable_field_maps_seq.currval || '.6');
insert into field_record_config_maps(ID,FIELD_CATEGORY_ID,RECORD_CONFIG_ID,FIELD_ASSOCIATION) 
	values(FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,48,10,'21');
