...
insert into analyst_actions(id, name, category, action_script, description, is_active, is_visible, controller_name) values
(25, 'Generate Life Style Profile','ALARM_CLOSER_ACTION','generate_lifestyle_profile_action','',1, 1, '') ;
