...
(
	...
	CONSTRAINT PK_DS_CO_ID PRIMARY KEY (ID)
) ;
...
(
	...
	CONSTRAINT PK_DS_IN PRIMARY KEY (DATASOURCE_NAME)
);
...
(
	...
	CONSTRAINT PK_OU_FO PRIMARY KEY (DATASOURCE_NAME)
);
...
(
	...
	CONSTRAINT PK_PA PRIMARY KEY (DATASOURCE_NAME) 
);
...
(
	...
	CONSTRAINT PK_AS_DE_PA_IN PRIMARY KEY (PARSER_NAME)
);
...
(
	...
	CONSTRAINT PK_AS_DE_FI_IN PRIMARY KEY (PARSER_NAME, FIELD_POSITION, FIELD_NAME)
);
...
(
	 ...
	 CONSTRAINT PK_VA PRIMARY KEY (DATASOURCE_NAME, FIELD_NAME, VALIDATOR_TYPE)
);
...
(
	 ...
	 CONSTRAINT PK_BU PRIMARY KEY (DATASOURCE_NAME, SEQUENCE, BUSINESSRULE_NAME),
...
(
	 ...
	 CONSTRAINT PK_FO PRIMARY KEY (DATASOURCE_NAME, FIELD_NAME, FORMATTER_TYPE, FORMATTER_NAME)
);
...
(
	 ...
	 CONSTRAINT PK_MA PRIMARY KEY (DATASOURCE_NAME, MANIPULATOR_TYPE, MANIPULATOR_NAME)
);
...
(
	...
	CONSTRAINT PK_DU_FI_MA PRIMARY KEY (MANIPULATOR_NAME,FIELD_NAME,NEW_FIELD_NAME)
);	
...
(
	...
	CONSTRAINT PK_MA_FI_CO_FI	PRIMARY KEY (FILTER_NAME, FIELD)
);
...
(
	...
	IS_ENABLED 				VARCHAR2(1) NOT NULL,
	CONSTRAINT PK_MA_FI PRIMARY KEY (FILTER_NAME, FIELD)
);
...
(
	 ...
	 CONSTRAINT PK_DS_FI PRIMARY KEY (DATASOURCE_NAME, FILTER_TYPE, FILTER_NAME)
);
...
(
	...
	IS_ENABLED 				VARCHAR2(1) NOT NULL,
	CONSTRAINT PK_PR_FI PRIMARY KEY (FILTER_NAME, FIELD_NAME, PREFIX_TO_MATCH)
);
...
(
	...
	CONSTRAINT PK_PA_CD_CO	PRIMARY KEY (FILTER_NAME)
);
...
(
	...
	CONSTRAINT PK_CA_TY_CO	PRIMARY KEY (DATASOURCE_NAME)	
);
...
(
	...
	PMN                         VARCHAR2(40) NOT NULL,
	CONSTRAINT PK_RA_CO PRIMARY KEY (DATASOURCE_NAME)
);
...
(
	...
	PHONE_NUMBER				VARCHAR2(50) NOT NULL,
	SUBSCRIBER_ID				VARCHAR2(50) NOT NULL,
	CONSTRAINT PK_SU_ID_CO PRIMARY KEY (DATASOURCE_NAME)
);
...
(
	...
	CONSTRAINT PK_UN_FO PRIMARY KEY (FORMATTER_NAME, NUMBER_TO_MATCH)
);
...
(
	...
	CONSTRAINT PK_TR_FO	PRIMARY KEY (FORMATTER_NAME)
);
...
(
	...
	CONSTRAINT PK_LT_FO	PRIMARY KEY (FORMATTER_NAME, TRIM_STRING)
);
...
(
    FORMATTER_NAME          VARCHAR2(50) NOT NULL,
    WIDTH              		NUMBER(10),
	CONSTRAINT PK_WI_CH_FO PRIMARY KEY (FORMATTER_NAME)
);
...
(
    FORMATTER_NAME          VARCHAR2(50) NOT NULL,
    WIDTH              		NUMBER(10),
	CONSTRAINT PK_WI_TR_FO PRIMARY KEY (FORMATTER_NAME)
);
...
(
	...
	CONSTRAINT PK_MA_FO	PRIMARY KEY (FORMATTER_NAME, FROM_VALUE)
);
...
(
	...
	CONSTRAINT PK_DA_FO	PRIMARY KEY (FORMATTER_NAME, INPUT_FORMAT)
);
...
(
	...
	CONSTRAINT PK_DI_FO PRIMARY KEY(FORMATTER_NAME)
);
...
(
	...
	CONSTRAINT PK_AS_CA_PA	PRIMARY KEY (PARSER_NAME, CALL_MODULE)
) ;
...
(
	...
	CONSTRAINT PK_AS_FI_PA PRIMARY KEY (CALL_MODULE, TAG_NAME)
);
...
(
	...
	CONSTRAINT PK_AS_PA_CO PRIMARY KEY (PARSER_NAME, ID)
) ;
...
(
	...
	CONSTRAINT PK_RF_FI_PO_MAP PRIMARY KEY (DATASOURCE_NAME, FIELD_POSITION)	
);
...
(
	...
	CONSTRAINT PK_BD_BL_CO PRIMARY KEY (PARSER_NAME)
) ;
...
(
    ...
    ID              VARCHAR2(50) NOT NULL,
    VALUE           VARCHAR2(100) NOT NULL,
	CONSTRAINT PK_BD_PA_CO	PRIMARY KEY (PARSER_NAME, ID)	
) ;
...
(
	...
	CONSTRAINT PK_BD_RE_CO PRIMARY KEY (RECORD_NAME)
) ;
...
(
	...
	CONSTRAINT PK_BD_FI_CO PRIMARY KEY (RECORD_NAME, FIELD_NAME),
...
(
	...
	CONSTRAINT PK_LCA PRIMARY KEY (DATASOURCE_NAME, LCA_NUMBER)
);
...
(
	...
	CONSTRAINT PK_LR PRIMARY KEY (DATASOURCE_NAME, STARTING_NUMBER, ENDING_NUMBER)
);
...
(
	...
	SEQUENCE            NUMBER(20,0) NOT NULL,
	CONSTRAINT PK_EX_RU PRIMARY KEY (RULE_NAME)
);
...
(
	...
	CONSTRAINT PK_EX_CO PRIMARY KEY (RULE_NAME, SEQUENCE),
...
(
    ...
    RULE_NAME           VARCHAR2(50) NOT NULL,
    SEQUENCE            NUMBER(20,0) NOT NULL,
	CONSTRAINT PK_FI_AR_RU PRIMARY KEY (RULE_NAME)
);
...
(
	...
	CONSTRAINT PK_FI_AR PRIMARY KEY (RULE_NAME)
);
...
(
	...
	CONSTRAINT PK_DATE_FO PRIMARY KEY (FORMAT_LOOKUP_ID)
);
...
(
	...
	CONSTRAINT PK_ST_PR_BU PRIMARY KEY (BUSINESSRULE_NAME, FIELD_NAME, PREFIX_TO_STRIP)	
);
...
(
	 ...
	 CONSTRAINT PK_RA_VA PRIMARY KEY (VALIDATOR_NAME)    	
);
