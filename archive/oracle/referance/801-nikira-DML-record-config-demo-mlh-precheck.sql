...
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter, category, 
	...
	values(126, 'ACCOUNT', 'Account', 0, 'SUBSCRIBER_ID', 0,  ',',  '', 0, 0, 0) ;

insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible, 
	is_cell_specific, is_primary_view) values (142, 'Precheck Account View', 126, '', 'ID ASC', 1, 0, 0, 1) ;
...
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Account Name', 'ACCOUNT_NAME', 0, 0, 1, 'GR', 3,'', 1, '', null, 1, 40, 8, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Date of Activation', 'ACCOUNT_DOA', 0, 0, 1, 'SMM.PRECHECK', 4,'', 2, '', null, 1, 11, null, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Network', 'NETWORK_ID', 0, 0, (select decode(count(*),1,0,1) from networks),'', 1,'', 3, '', 10, 1, 20, null, null, null ) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'First Name', 'FIRST_NAME', 0, 0, 1, 'SMM.PRECHECK GR', 3,'', 4, '', null, 1, 40, 8, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Middle Name', 'MIDDLE_NAME', 0, 0, 1, 'SMM.PRECHECK GR', 3,'', 5, '', null, 1, 40, 8, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Last Name', 'LAST_NAME', 0, 0, 1, 'SMM.PRECHECK GR', 3,'', 6, '', null, 1, 40, 8, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Address Line 1', 'ADDRESS_LINE_1', 0, 0, 1, 'SMM.PRECHECK GR', 3,'', 7, '', null, 1, 256, 19, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Address Line 2', 'ADDRESS_LINE_2', 0, 0, 1, 'SMM.PRECHECK GR', 3,'', 8, '', null, 1, 256, 19, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Address Line 3', 'ADDRESS_LINE_3', 0, 0, 1, 'SMM.PRECHECK GR', 3,'', 9, '', null, 1, 256, 19, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'City', 'CITY', 0, 0, 1, 'SMM.PRECHECK GR', 3,'', 10, '', null, 1, 40, 8, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Post Code', 'POST_CODE', 0, 0, 1, 'SMM.PRECHECK CMM.STATIC.FORMULA GR', 3,'', 11, '', null, 1, 20, 9, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Credit Limit', 'CREDIT_LIMIT', 0, 0, 1, 'SMM.AG.POSTPAID SMM.AG.PREPAID CMM.STATIC.FORMULA CMM.DYNAMIC.FORMULA GR ENTITY_DATA', 2,'', 12, '', null, 1, 40, null, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Rate Plan', 'RATE_PLAN', 0, 0, 1, 'CMM.STATIC.RULE CMM.DYNAMIC.RULE GR', 3,'', 13, '', null, 1, 256, 9, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Parent Account ID', 'PARENT_ID', 0, 0, 1, '', 8, '', 14, '', null, 1, 20, null, null, 26) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Hierarchy ID', 'HIERARCHY_ID', 0, 0, 1, '', 8, '', 15, '', null, 1, 20, null, null, 26) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Modified Date', 'MODIFIED_DATE', 0, 0, 1, '', 4, '', 16, '', null, 1, 1, null, null, 20) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Account Type', 'ACCOUNT_TYPE', 0, 0, 1, '', 1, '', 17, '', 555, 1, 20, null, null, 14) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'FRD Indicator', 'FRD_INDICATOR', 0, 0, 1, '', 1, '', 18, '', null, 1, 38, null, null, 14) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Account ID', 'ID', 0, 0, 1, '', 8, '', 19, '', null, 1, 1, null, null, 6) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	 values (field_configs_seq.nextval, 126, 'Groups', 'GROUPS', 0, 0, 1, 'GR', 7, '', 20, '', 516, 1, 256, null, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (field_configs_seq.nextval, 126, 'Comments', 'COMMENTS', 0, 0, 1, '', 3, '', 21, '', null, 1, 512, 10, null, 19) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (field_configs_seq.nextval, 126, 'Notification Groups', 'NOTIFICATION_GROUPS', 0, 0, 1, 'GR', 7, '', 22, '', 703, 1, 256, null, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (field_configs_seq.nextval, 126, 'Customer Alert Phone Number','CUST_ALERT_CONTACT_NUMBER', 0, 0, 1, '', 3, '', 23,  '', null, 1, 40,  1,    null,  null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (field_configs_seq.nextval, 126, 'Customer Alert Email Id','CUST_ALERT_EMAIL_ID', 0, 0, 1, '', 3,  '', 24,  '', null, 1, 256,  22,    null,  null) ;
...
values (precheck_record_configs_seq.nextval, 4, 126, 142, 19, 19) ;
