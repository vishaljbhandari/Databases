...
INSERT INTO DU_SGSN_ADDRESSES SELECT * FROM DU_SGSN_ADDRESSES@DU_RANGER ;
INSERT INTO ROAMER_PARTNER SELECT * FROM ROAMER_PARTNER@DU_RANGER ;
...
FROM RATER_SPECIAL_NUMBER@DU_RANGER ;
...
INSERT INTO CELL_SITE_GEO_POSITIONS (ID, CELL_SITE_ID, LONGITUDE, LATITUDE, CELL_LOCATION, RADIUS_COVERAGE, NETWORK_ID, TIME_ZONE)
	...
	FROM CELL_SITE_GEO_POSITION@DU_RANGER ;

INSERT INTO LOCAL_NUMBER SELECT * FROM LOCAL_NUMBER@DU_RANGER ;

INSERT INTO SDR_RATES (ID, START_DATE, END_DATE, SDR_VALUE)
	SELECT SDR_RATES_SEQ.nextval, START_DATE, END_DATE, SDR_VALUE FROM SDR_RATE@DU_RANGER ;
INSERT INTO NETWORKS_SDR_RATES (SDR_RATE_ID, NETWORK_ID) SELECT ID, 999 FROM SDR_RATES ;

INSERT INTO DU_RECORD_TYPE SELECT * FROM DU_RECORD_TYPE@DU_RANGER ;
INSERT INTO DU_RECHARGE_RATE_TYPES SELECT * FROM DU_RECHARGE_RATE_TYPES@DU_RANGER ;
INSERT INTO DU_RECHARGE_TYPES SELECT * FROM DU_RECHARGE_TYPES@DU_RANGER ;
INSERT INTO DU_OPC_DPC SELECT * FROM DU_OPC_DPC@DU_RANGER ;
INSERT INTO PREPAID_SUBSCRIBER SELECT * FROM PREPAID_SUBSCRIBER@DU_RANGER ;
INSERT INTO CLI_SUBSCRIBER_NUMBER_MAP SELECT * FROM CLI_SUBSCRIBER_NUMBER_MAP@DU_RANGER ;
INSERT INTO DU_NRTRDE_RATE SELECT * FROM DU_NRTRDE_RATE@DU_RANGER ;

INSERT INTO FREE_NUMBERS (ID, FREE_NUMBER, DESCRIPTION)
	SELECT FREE_NUMBERS_SEQ.nextval, FREE_NUMBER, DESCRIPTION FROM FREE_NUMBER@DU_RANGER ;
...
INSERT INTO ZONE_CODES (ID, ZONE_CODE, DESCRIPTION)
	SELECT ZONE_CODES_SEQ.nextval, ZONE_CODE, DESCRIPTION FROM ZONE_CODE@DU_RANGER ;
...
FROM RATE_PER_CALL@DU_RANGER ;

INSERT INTO RATE_TYPES (ID, RATE_TYPE, DESCRIPTION)
	SELECT RATE_TYPES_SEQ.nextval, RATE_TYPE, DESCRIPTION FROM RATE_TYPE@DU_RANGER ;
...
INSERT INTO TIME_ZONE_RATE_TYPES(ID, DAY_TYPE, START_TIME, END_TIME, SERVICE_CATEGORY, NATIONAL_FLAG, RATE_TYPE)
	...
	FROM TIME_ZONE_RATE_TYPE@DU_RANGER ;
...
SELECT
	...
	PSTN_MIN_CHARGE, PSTN_PULSE, PSTN_RATE, FF_MIN_CHARGEABLE_UNIT, FF_MIN_CHARGE, FF_PULSE, FF_RATE,
	FF_PSTN_MIN_CHARGEABLE_UNIT, FF_PSTN_MIN_CHARGE, FF_PSTN_PULSE, FF_PSTN_RATE, EXTRA_CHARGE
FROM RATE_PLAN@DU_RANGER ;

INSERT INTO HOLIDAY_LISTS(ID, HOLIDAY_DATE, DESCRIPTION)
	SELECT HOLIDAY_LISTS_SEQ.nextval, HOLIDAY_DATE, DESCRIPTION FROM HOLIDAY_LIST@DU_RANGER ;
...
INSERT INTO WEEKENDS(ID, WEEKEND, DESCRIPTION)
	SELECT WEEKENDS_SEQ.nextval, WEEKEND, DESCRIPTION FROM WEEKEND@DU_RANGER ;

INSERT INTO DEFAULT_RATES(ID, RATE_TYPE, CALL_TYPE, PULSE, RATE)
	SELECT DEFAULT_RATES_SEQ.nextval, RATE_TYPE, CALL_TYPE, PULSE, RATE FROM DEFAULT_RATE@DU_RANGER ;

INSERT INTO RCF_INFOS (ID, LETTER_CODE, VPLMN_ID, IMSI_CODE, PLMN_NAME)
	SELECT RCF_INFOS_SEQ.nextval, LETTER_CODE, VPLMN_ID, IMSI_CODE, PLMN_NAME FROM RCF_INFO@DU_RANGER ;

INSERT INTO RATING_CONFIGURATION SELECT * FROM RATING_CONFIGURATION@DU_RANGER ;
INSERT INTO DU_SPECIAL_NUMBERS SELECT * FROM DU_SPECIAL_NUMBERS@DU_RANGER ;
INSERT INTO COUNTRY_CODES(CODE, DESCRIPTION) SELECT CODE, DESCRIPTION FROM COUNTRY_CODE@DU_RANGER ;
INSERT INTO ZONECODE_COUNTRYCODE_MAP SELECT * FROM ZONECODE_COUNTRYCODE_MAP@DU_RANGER ;
INSERT INTO DU_SERVICE_ID_DESCRIPTION SELECT * FROM DU_SERVICE_ID_DESCRIPTION@DU_RANGER ;
INSERT INTO DU_MOBILE_CONTENT_SERVICES SELECT * FROM DU_MOBILE_CONTENT_SERVICES@DU_RANGER ;
INSERT INTO GSM_PREFIX SELECT * FROM GSM_PREFIX@DU_RANGER ;

INSERT INTO DUPLICATE_CDR_FILE_CONFIG SELECT * FROM DUPLICATE_CDR_FILE_CONFIG@DU_RANGER ;
...
--INSERT INTO SELECT * FROM CDR_FILE_DETAIL@DU_RANGER ;
--INSERT INTO CDR_FILE_DETAIL SELECT * FROM CDR_FILE_DETAIL@DU_RANGER
--	WHERE DS_TYPE IS NOT NULL AND FILE_NAME IS NOT NULL AND TIME_STAMP IS NOT NULL AND FILE_SIZE IS NOT NULL ;

INSERT INTO DS_ASCII_INPUT_CONFIGURATION SELECT * FROM DS_ASCII_INPUT_CONFIGURATION@DU_RANGER ;
INSERT INTO PARTIAL_CDR_INFO SELECT * FROM PARTIAL_CDR_INFO@DU_RANGER ;
INSERT INTO SPECIAL_NUMBER SELECT * FROM SPECIAL_NUMBER@DU_RANGER ;
