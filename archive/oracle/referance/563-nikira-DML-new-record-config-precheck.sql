...
insert into basic_filter_configs (id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory, min, max, translation_id) 
	values (basic_filter_seq.nextval, 124, 140,  3, 0, 1, 0, null, null, null);
insert into basic_filter_configs (id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory, min, max, translation_id) 
	values (basic_filter_seq.nextval, 124, 140,  4, 8, 2, 0, null, null, null);
insert into basic_filter_configs (id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory, min, max, translation_id) 
	values (basic_filter_seq.nextval, 124, 140,  5, 8, 3, 0, null, null, '560');
insert into basic_filter_configs (id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory, min, max, translation_id) 
	values (basic_filter_seq.nextval, 124, 140,  8, 10, 4, 0, null, null, null);
insert into basic_filter_configs (id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory, min, max, translation_id) 
	values (basic_filter_seq.nextval, 124, 140,  9, 10, 5, 0, null, null,  null);
insert into basic_filter_configs (id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory, min, max, translation_id) 
	values (basic_filter_seq.nextval, 124, 140, 10, 8, 6, 0, null, null, '549');
