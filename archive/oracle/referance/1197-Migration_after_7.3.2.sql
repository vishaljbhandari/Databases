...
@VOICE@insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,14,101,'IS_CURRENCY',1);

-- nikira-DML-new-record-config-recharge.sql
@RECHARGE@insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,3,60,'IS_CURRENCY',1);
@RECHARGE@insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,4,60,'IS_CURRENCY',1);

-- nikira-DML-new-record-config-isp.sql
@ISP@update record_view_configs set is_advanced_query_enabled = 1 where id = 104 and record_config_id = 83 and name = 'IPDR' ; 
@ISP@insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,10,83,'IS_CURRENCY',1);
...
@NRTRDE@update field_configs set reg_exp_id = 18 where id in (1501, 1505) and record_config_id = 42 ;
@NRTRDE@update field_configs set reg_exp_id = 10, translation_id = 41 where id = 1504 and record_config_id = 42 ;
@NRTRDE@update field_configs set reg_exp_id = 15 where id = 1508 and record_config_id = 42 ;
...
@VOICE@insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,14,1,'IS_CURRENCY',1);
@VOICE@insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (2005, 'Geographic Position CDR', 15, 'END_VALUE', 1, 'GEOGRAPHIC_POSITION', 0, 14, 'RECORD_VIEW GR RULE');

-- nikira-DML-record-config-demo-gprs.sql
@GPRS@insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,13,7,'IS_CURRENCY',1);

-- nikira-DML-record-config-demo-recharge.sql
@RECHARGE@insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,3,2,'IS_CURRENCY',1);

-- nikira-DML-record-config-demo-isp.sql
@ISP@insert into filter_index_fields(record_config_id, field_id) values(83, 12) ;

@ISP@insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_map_seq.nextval, 212, 83, '254.32') ;
...
@ISP@update aggregation_types set RECORD_CONFIG_IDS= RECORD_CONFIG_IDS || ',83' where id = 16 ;  
...
@STATISTICAL_RULES@@STATISTICAL_RULES_AGGREGATE_ON_SUBSCRIBER@update profile_field_entities set element_datastream_ids='1,2,7' where id=2; 
...
@NRTRDE@	insert into rules (id, parent_id, key, name, version, aggregation_type, accumulation_field, accumulation_function,
@NRTRDE@					   is_enabled, created_time, modification_time, severity, user_id, description, processor_type, category)
@NRTRDE@			values
@NRTRDE@								(rule_seq, 999, rule_seq, 'Before Updating VPMN Copy VPMN ID', 0, 200, 0, 0, 1,
@NRTRDE@															sysdate, sysdate, 100, 'radmin', '', 1, 'DISPATCHER.VPMN.STORE') ;
...
@NRTRDE@					   is_enabled, created_time, modification_time, severity, user_id, description, processor_type, category)
@NRTRDE@			values
@NRTRDE@								(rule_seq, 999, rule_seq, 'Update VPMN Record', 0, 200, 0, 0, 1,
@NRTRDE@															sysdate, sysdate, 100, 'radmin', '', 1, 'DISPATCHER.VPMN.STORE') ;
@NRTRDE@	insert into record_configs_rules (rule_id, record_config_id) values (s_rule_seq.currval, 42) ;
...
@INTERNAL_USER@insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,5,71,'FLOAT_PRECISION',2);
@INTERNAL_USER@insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,5,71,'IS_CURRENCY',1);

--- nikira-DML-rtf-exec.sql
@RTF@insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,3,103,'IS_CURRENCY',1);
@RTF@insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,7,105,'IS_CURRENCY',1);

--- nikira-DML-aggregation-isp.sql
@ISP@delete from counter_maps where category = 'PROFILE_FIELD' and aggregation_type = 225 
@ISP@	and function_id in (1,2) and record_config_id = 83 and counter_type = 201 ;
...
@ISP@ update expressions set RIGHT_FIELD='%' where LEFT_FIELD='12' and RIGHT_FIELD='+%' and 
...
@NRTRDE@ insert into dac_record_views_tasks (select dac_record_views_tasks_seq.nextval, 49, id from tasks 
...
@RTF@@ Additional_fourth_Migration_after_7.3.2.sql
