...
insert into functions values (51, 'Per Session', '49,50,51', 1);
...
insert into pseudo_functions (id, name, category, accumulation_function_id, accumulation_field_id) Values (14, 'Per Call Data Volume', 'TEMPLATE RULE ONDEMAND_OFFLINE_TEST', 6, 51) ;
...
-- Cumulative function for across session usage
insert into functions(id, function_name, associated_accumulation_fields,is_counter_response_reqd) values(57, 'Total data volume across sessions', '', 1) ;
insert into pseudo_functions (id, name, category, accumulation_field_id, accumulation_function_id, addtnl_accumulation_field_id) values (1025, 'Total download volume across sessions', 'TEMPLATE RULE ONDEMAND_OFFLINE_TEST PROFILE_FIELD', 49, 57, 2064) ;
insert into pseudo_functions (id, name, category, accumulation_field_id, accumulation_function_id, addtnl_accumulation_field_id) values (1026, 'Total upload volume across sessions', 'TEMPLATE RULE ONDEMAND_OFFLINE_TEST PROFILE_FIELD', 50, 57, 2064) ;
