...
insert into field_categories(id, name, category, data_type, regular_expression_id, COMMON_CATEGORY_ID) values(225 , 'User Name' , 'ACCUMULATION_FIELD AGGREGATION_TYPE NEGATIVE_RULE_AGG_TYPE NICKNAME HOTLIST MANUAL_ALARM PROFILE_SPECIFIC ONDEMAND_OFFLINE_TEST STATS_RULE_AGG_TYPE', 3, 8, 225);
