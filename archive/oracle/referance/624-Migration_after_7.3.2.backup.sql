...
--<START>
    ...
    --  Impacts     :   
	 ...
	 update record_view_configs set is_advanced_query_enabled = 1 where id=104;
	 delete from counter_maps where category='PROFILE_FIELD' and aggregation_type=225 and record_config_id=83 and counter_type=201 ;
...
--<START>
 ...
 insert into dac_record_views_tasks (select dac_record_views_tasks_seq.nextval, 49, id from tasks where link like '%record_view/list/49?fetch_records=%') ;
     ...
     update field_configs set reg_exp_id=18 where record_config_id=42 and field_id=2 ;   
     update field_configs set reg_exp_id=10 where record_config_id=42 and field_id=5 ;   
     update field_configs set reg_exp_id=18 where record_config_id=42 and field_id=6 ;   
     update field_configs set reg_exp_id=15 where record_config_id=42 and field_id=9 ;   
--<END>
...
--<START>
 ...
 update expandable_field_maps set SOURCE_KEY='VPMN, NETWORK_ID', DEST_KEY='NETWORK_ID' where id =125;
 update expandable_field_maps set SOURCE_KEY='VPMN, NETWORK_ID', DEST_KEY='NETWORK_ID' where id =121;
 update expandable_field_maps set SOURCE_KEY='VPMN, NETWORK_ID', DEST_KEY='NETWORK_ID' where id =514;
 update field_configs set translation_id = 41 where record_config_id=42 and field_id =5 ; 
