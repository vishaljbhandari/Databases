...
insert into source_fms_log (id,event_name,source_id) values (44,'Hotlist Equipment ID Added',7);
insert into source_fms_log (id,event_name,source_id) values (45,'Hotlist Equipment ID Modified',7);
insert into source_fms_log (id,event_name,source_id) values (46,'Hotlist Equipment ID deleted',7);
