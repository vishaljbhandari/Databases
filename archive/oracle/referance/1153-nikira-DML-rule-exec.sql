...
------ Update IMEI Rule ------------
INSERT INTO rules (ID,PARENT_ID,KEY,NAME,VERSION,AGGREGATION_TYPE,ACCUMULATION_FIELD,ACCUMULATION_FUNCTION,PSEUDO_FUNCTION_ID,IS_ENABLED,CREATED_TIME,MODIFICATION_TIME,SEVERITY,USER_ID,DESCRIPTION,PROCESSOR_TYPE,CATEGORY,IS_ACTIVE) VALUES ('1','999','1','RuleForUpdateIMEI','0','2','1','0',NULL,'0',TO_DATE('2007-01-04 11:07:39','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2007-01-04 11:07:39','YYYY-MM-DD HH24:MI:SS'),'1','radmin',NULL,'1','SYSTEM_RULES','0');
...
INSERT INTO rules (ID,PARENT_ID,KEY,NAME,VERSION,AGGREGATION_TYPE,ACCUMULATION_FIELD,ACCUMULATION_FUNCTION,PSEUDO_FUNCTION_ID,IS_ENABLED,CREATED_TIME,MODIFICATION_TIME,SEVERITY,USER_ID,DESCRIPTION,PROCESSOR_TYPE,CATEGORY,IS_ACTIVE) values (rules_seq.nextval, '999', rules_key_seq.nextval , 'Update Total Calls For Subscriber','0','2','0','0',NULL,'0',sysdate,sysdate,'1','radmin',NULL,'1','SYSTEM_RULES','0');
...
----Configuration entry for overlap IMEI----------
insert into configurations(id, config_key, value) values(configurations_seq.nextval,'IS_OVERLAP_IMEI_ENABLED','0') ;
commit ;
