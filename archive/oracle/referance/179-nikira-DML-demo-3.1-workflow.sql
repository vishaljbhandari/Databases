...
update alarms set  wf_assigned_date = null, wf_modified_date = null ;
...
insert into activity_templates (id,name,description,template_type,execution_type) values (501,'Test - Observe Action','Input Copy',2,0);
insert into activity_templates (id,name,description,template_type,execution_type) values (502,'Test - Dummy Action','Yes Always',2,0);
...
insert into activity_inputs (id,name,description,property_indicator,value,data_type, default_value) values (601,'Outstanding Amount','Enrichment Outstanding Amount ',2,'50.226.6',2,'175');
insert into activity_inputs (id,name,description,property_indicator,value,data_type, default_value) values (602,'Static Credit Limit','Enrichment Static Credit Limit ',2,'50.226.3',2,'150');
insert into activity_inputs (id,name,description,property_indicator,value,data_type, default_value) values (603, 'Payment Ready Status', 'Ready for Payment ', 1, 6, 6, null);
insert into activity_inputs (id,name,description,property_indicator,value,data_type, default_value) values (604,'Customer Account Number','Enrichment Alarms.Alarm-Subscriber.Account Name ',2,'62.1',3,'Default');
insert into activity_inputs (id,name,description,property_indicator,value,data_type, default_value) values (605,'Paying Amount','Paying amount ',1,'2',2, null) ;
insert into activity_inputs (id,name,description,property_indicator,value,data_type, default_value, translation_id) values (606,'Network','Network ',2,'1',1,1025, 10) ;
insert into activity_inputs (id,name,description,property_indicator,value,data_type, default_value, translation_id) values (607,'Group','Groups',2,'20',7,'MVN,AGN', 27) ;
insert into activity_inputs (id,name,description,property_indicator,value,data_type, default_value) values (608,'Date','Date',2,'6',4,'2010/12/23') ;
...
insert into activity_outputs_labels (id,activity_output_id,name) values (761,706,'Any');                     

insert into activities (id,name,description,jeopardy_period,activity_template_id,is_automatic,input_ids,output_id) 
	values (801,'Test - Check for Outstanding Amount ','Check for Outstanding Amount',1,501,1,'601',701);
insert into activities (id,name,description,jeopardy_period,activity_template_id,is_automatic,input_ids,output_id) 
	values (802,'Test - Static Credit Limit Verification','Static Credit Limit Verification',1,502,0,'602',702);
insert into activities (id,name,description,jeopardy_period,activity_template_id,is_automatic,input_ids,output_id) 
	values (803,'Test - Ask for Outstanding Amount Payment Readiness','Ask for Outstanding Amount Payment',1,501,0,'603,606,607,608',703);
insert into activities (id,name,description,jeopardy_period,activity_template_id,is_automatic,input_ids,output_id) 
	values (804,'Test - Amount Verification ','Amount Verification',1,501,1,'605,606,607,608',704);
insert into activities (id,name,description,jeopardy_period,activity_template_id,is_automatic,input_ids,output_id) 
	values (805,'Test - Customer Address Verification','Address Verification',1,502,1,'604',705);
insert into activities (id,name,description,jeopardy_period,activity_template_id,is_automatic,input_ids,output_id) 
	values (806,'Test - Send Intimation','Send Intimation',1,502,0,'604,606,607,608',706);
insert into activities (id,name,description,jeopardy_period,activity_template_id,is_automatic,input_ids,output_id) 
	values (807,'Test - Send Reminder','Send Reminder',1,502,1,'604',706);
insert into activities (id,name,description,jeopardy_period,activity_template_id,is_automatic,input_ids,output_id) 
	values (808,'Test - Send Account Closure Notification','Send Account Closure Notification',1,502,1,'604',706);
...
insert into workflows (id, name, description) values (4000, ' Test - Subscription Fraud Analysis', 'Workflow to investigate the subscription fraud cases.') ;
...
insert into workflow_activity_steps ( id,workflow_id,activity_id,activity_label,step_id,position) 
	values(3010, 4000, 000, 'End', 10, '[326.0, 744.0]') ;
...
--insert into workflow_keys (id, workflow_id, fraud_type, reference_type, network_id) values(6000, 4000, 1, 1, 999) ;

update configurations  set value = '10.113.58.7' where config_key = 'NOTIFICATION_MANAGER_HOST';
update configurations  set value = '10.113.58.7' where config_key = 'ACTIVITY_EXECUTOR_HOST';
