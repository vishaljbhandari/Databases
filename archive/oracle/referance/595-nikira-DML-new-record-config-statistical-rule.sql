...
-- Statistical Rules
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible, is_cell_specific, is_primary_view,is_logging_enabled) values(94,'Statistical Rules',91,'IS_ACTIVE = 1 AND CATEGORY = ''STATISTICAL_RULE''','KEY ASC', 1, 0,0, 1, 1) ;
