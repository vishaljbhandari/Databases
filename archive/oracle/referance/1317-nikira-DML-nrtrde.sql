...
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(basic_filter_configs_seq.nextval, 42, 49, 5, 8, 1, 0) ;
...
insert into modulo_dispatcher_categories  (record_config_id, field_category_id, enabled) values (42,200,1) ;
