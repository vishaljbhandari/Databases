...
insert into alarm_xdr_maps( ID,LOOKUP_TABLE_NAME,RECORD_CONFIG_ID) values(alarm_xdr_maps_seq.nextval,'OBSERVATION_SUMMARY_RECORDS',116);
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (62, 'Alarm-Subscriber', 10, 'REFERENCE_VALUE,REFERENCE_ID', 3, 'PHONE_NUMBER,ID', 0, 1, 'RECORD_VIEW WORK_FLOW');
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key,  is_new_view, dest_key_type, category) values (69, 'Alarm-Subscriber', 19, 'REFERENCE_VALUE,REFERENCE_ID', 102, 'PHONE_NUMBER,ID', 0, 1, 'RECORD_VIEW');
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (95, 'Alarm-Subscriber', 16, 'REFERENCE_VALUE,REFERENCE_ID', 3, 'PHONE_NUMBER,ID', 0, 1, 'RECORD_VIEW');
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (99, 'Alarm-Subscriber', 17, 'REFERENCE_VALUE,REFERENCE_ID', 102, 'PHONE_NUMBER,ID', 0, 1, 'RECORD_VIEW');
...
--- For Alarm Admin ( Assigned Alarms )--
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (103, 'Alarm-Subscriber', 18, 'REFERENCE_VALUE,REFERENCE_ID', 3, 'PHONE_NUMBER,ID', 0, 1, 'RECORD_VIEW');
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (107, 'Alarm-Subscriber', 26, 'REFERENCE_VALUE,REFERENCE_ID', 102, 'PHONE_NUMBER,ID', 0, 1, 'RECORD_VIEW');
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (111, 'Alarm-Subscriber', 27, 'REFERENCE_VALUE,REFERENCE_ID', 3, 'PHONE_NUMBER,ID', 0, 1, 'RECORD_VIEW');
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (184, 'Alarm-Subscriber', 50, 'REFERENCE_VALUE,REFERENCE_ID', 102, 'PHONE_NUMBER,ID', 0, 1, 'RECORD_VIEW');
...
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) ( select field_record_config_map_seq.nextval,field_category_id,98, field_association from field_record_config_maps where record_config_id=3) ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) ( select field_record_config_map_seq.nextval,field_category_id,99, field_association from field_record_config_maps where record_config_id=4) ;
...
-- For Alarm Aggregation Type
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (expandable_field_maps_seq.nextval, 'Alarm-Subscriber', 116, 'REFERENCE_VALUE,REFERENCE_ID', 3, 'PHONE_NUMBER,ID', 0, 1, 'RECORD_VIEW');
...
INSERT INTO NO_DENORMALIZATION_TYPES (ID,RECORD_CONFIG_ID,DESCRIPTION) VALUES(7,116,'OBSERVATION_SUMMARY_RECORDS') ;
...
insert into field_record_config_maps(id,field_category_id,record_config_id,field_association) values(field_record_config_map_seq.nextval,5001,3,to_char(expandable_field_maps_seq.currval) || '.32' );
