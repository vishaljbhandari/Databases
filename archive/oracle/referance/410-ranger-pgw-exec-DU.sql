...
delete from rule_creation_record_configs where record_config_id = 1024 ;
...
insert into rule_creation_record_configs(ID,RECORD_CONFIG_ID,TASK_ID,CATEGORY) values (19, 1024, GetParentID('PGW Rule Creation'), 'RULE') ;
insert into rule_creation_record_configs(ID,RECORD_CONFIG_ID,TASK_ID,CATEGORY) values (20, 1024, GetParentID('PGW Template Creation'), 'TEMPLATE') ;
