...
---- Inserting default rule and match configuration entries 
	...
	INSERT INTO FILTERS (ID, RECORD_CONFIG_ID, IS_EXCEPTION, NETWORK_ID, IS_ACTIVE) VALUES (filters_seq.nextval, 121, 0, 999, 1) ;
	...
	INSERT INTO PRECHECK_LISTS (ID, NAME, KEY, RECORD_CONFIG_ID, FILTER_ID, VERSION, CREATED_DATE, MODIFIED_DATE, USER_ID, IS_ACTIVE, IS_ENABLED, DESCRIPTION) 
					VALUES (precheck_lists_seq.nextval, 'AlarmLinkPrecheckList', 1, 121, filters_seq.currval, 0, sysdate, sysdate, 3, 1, 1, 'AlarmLinkPrecheckList') ;
