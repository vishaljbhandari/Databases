...
insert into tags(select tags_seq.nextval, description, 'DATA_STREAMS' from record_configs where is_visible = 1 and category like '%RULE_TAGS%') ;
...
insert into tags(select tags_seq.nextval, name ,'SPECIAL_RULES' from pseudo_functions where category in('NEGATIVE_RULE', 'STATISTICAL_RULE','FINGERPRINT_RULE'));
...
INSERT INTO rules (ID,PARENT_ID,KEY,NAME,VERSION,AGGREGATION_TYPE,ACCUMULATION_FIELD,ACCUMULATION_FUNCTION,PSEUDO_FUNCTION_ID,IS_ENABLED,CREATED_TIME,MODIFICATION_TIME,SEVERITY,USER_ID,DESCRIPTION,PROCESSOR_TYPE,CATEGORY,IS_ACTIVE) VALUES ('2','999','2','RuleForPrepaidUpdation','0','2','1','0',NULL,'0',TO_DATE('2007-01-04 11:07:39','YYYY-MM-DD HH24:MI:SS'),TO_DATE('2007-01-04 11:07:39','YYYY-MM-DD HH24:MI:SS'),'1','radmin',NULL,'1',NULL,'1');
...
insert into modulo_dispatcher_categories (record_config_id, field_category_id) values (3, 7) ;
...
insert into modulo_dispatcher_categories (record_config_id, field_category_id) values (4, 7) ;
...
insert into rules values (rules_seq.nextval, 999, rules_key_seq.nextval,'My notification coloring rule for unread for nadmin', 0, 0, 0, 0, null, 1, sysdate, sysdate, 100, 'nadmin', null, 1, 'COLORING_RULES', 1, 0, 0 , 0) ;
...
insert into rules values (rules_seq.nextval, 999, rules_key_seq.nextval,'My notification coloring rule for unread for radmin', 0, 0, 0, 0, null, 1, sysdate, sysdate, 100, 'radmin', null, 1, 'COLORING_RULES', 1, 0, 0, 0 ) ;
insert into rule_color_maps values (rule_color_maps_seq.nextval, rules_seq.currval, '#D7FFAE') ;
insert into record_configs_rules (rule_id, record_config_id) values (rules_seq.currval, 82 );
insert into filters_rules values (filters_seq.currval, rules_seq.currval) ;

---------My Notifications coloring rule for default
insert into rules values (rules_seq.nextval, 999, rules_key_seq.nextval,'My notification coloring rule for unread for default', 0, 0, 0, 0, null, 1, sysdate, sysdate, 100, 'default', null, 1, 'COLORING_RULES', 1, 0, 0, 0 ) ;
insert into rule_color_maps values (rule_color_maps_seq.nextval, rules_seq.currval, '#D7FFAE') ;
insert into record_configs_rules (rule_id, record_config_id) values (rules_seq.currval, 82 );
insert into filters_rules values (filters_seq.currval, rules_seq.currval) ;
...
---------My Notifications coloring rule for nadmin
insert into rules values (rules_seq.nextval, 999, rules_key_seq.nextval,'My notification coloring rule for read for nadmin', 0, 0, 0, 0, null, 1, sysdate, sysdate, 100, 'nadmin', null, 1, 'COLORING_RULES', 1, 0, 0, 0 ) ;
insert into rule_color_maps values (rule_color_maps_seq.nextval, rules_seq.currval, '#FFFFFF') ;
insert into record_configs_rules (rule_id, record_config_id) values (rules_seq.currval, 82 );
insert into filters_rules values (filters_seq.currval, rules_seq.currval) ;

---------My Notifications coloring rule for radmin
insert into rules values (rules_seq.nextval, 999, rules_key_seq.nextval,'My notification coloring rule for read for radmin', 0, 0, 0, 0, null, 1, sysdate, sysdate, 100, 'radmin', null, 1, 'COLORING_RULES', 1, 0, 0, 0) ;
insert into rule_color_maps values (rule_color_maps_seq.nextval, rules_seq.currval, '#FFFFFF') ;
insert into record_configs_rules (rule_id, record_config_id) values (rules_seq.currval, 82 );
insert into filters_rules values (filters_seq.currval, rules_seq.currval) ;

---------My Notifications coloring rule for default
insert into rules values (rules_seq.nextval, 999, rules_key_seq.nextval,'My notification coloring rule for read for default', 0, 0, 0, 0, null, 1, sysdate, sysdate, 100, 'default', null, 1, 'COLORING_RULES', 1, 0, 0, 0) ;
insert into rule_color_maps values (rule_color_maps_seq.nextval, rules_seq.currval, '#FFFFFF') ;
insert into record_configs_rules (rule_id, record_config_id) values (rules_seq.currval, 82 );
insert into filters_rules values (filters_seq.currval, rules_seq.currval) ;
...
---------  nadmin
insert into rules values (rules_seq.nextval, 999, rules_key_seq.nextval,'Rule Status Equal Disabled - nadmin', 0, 0, 0, 0, null, 1, sysdate, sysdate, 100, 'nadmin', null, 1, 'COLORING_RULES', 1, 0, 0, 0 ) ;
...
--------- radmin
insert into rules values (rules_seq.nextval, 999, rules_key_seq.nextval, 'Rule Status Equal Disabled - radmin', 0, 0, 0, 0, null, 1, sysdate, sysdate, 100, 'radmin', null, 1, 'COLORING_RULES', 1, 0, 0, 0) ;
insert into rule_color_maps values (rule_color_maps_seq.nextval, rules_seq.currval, '#CCCCCC') ;
insert into record_configs_rules (rule_id, record_config_id) values (rules_seq.currval, 44);
insert into record_configs_rules (rule_id, record_config_id) values (rules_seq.currval, 46);
insert into record_configs_rules (rule_id, record_config_id) values (rules_seq.currval, 78);
...
--------- default
insert into rules values (rules_seq.nextval, 999, rules_key_seq.nextval, 'Rule Status Equal Disabled - default', 0, 0, 0, 0, null, 1, sysdate, sysdate, 100, 'default', null, 1, 'COLORING_RULES', 1, 0, 0, 0) ;
insert into rule_color_maps values (rule_color_maps_seq.nextval, rules_seq.currval, '#CCCCCC') ;
insert into record_configs_rules (rule_id, record_config_id) values (rules_seq.currval, 44);
insert into record_configs_rules (rule_id, record_config_id) values (rules_seq.currval, 46);
insert into record_configs_rules (rule_id, record_config_id) values (rules_seq.currval, 78);
...
insert into rules_tags (rule_id, tag_id) (select r.id, t.id from rules r , tags t where t.name in ('CDR', 'GPRS', 'Recharge Log') and t.category='DATA_STREAMS' and r.category = 'MANUAL_ALARM_RULES');
...
insert into grouped_field_configs (ID, NAME, RECORD_CONFIG_ID, FIELD_IDS, DATA_TYPE, CATEGORY_ID) values (grouped_field_configs_seq.nextval, 'UNF Number', 1, '3,4,5', 3, 2);
