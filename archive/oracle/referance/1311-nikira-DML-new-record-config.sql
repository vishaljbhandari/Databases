...
delete from field_configs where record_config_id in (3, 4, 5, 6, 8, 10, 11, 20, 15, 21, 14, 16, 17, 22, 23, 24, 53, 54, 70, 71, 72, 501) ;
delete from record_view_configs where record_config_id in (3, 4, 5, 6, 8, 10, 11, 20, 15, 21, 14, 16, 17, 60, 64, 65, 70, 71, 72, 501) ;
delete from record_configs where id in (3, 4, 5, 6, 8, 10, 11, 20, 15, 21, 14, 16, 17, 22, 23, 24, 53, 54, 70, 71, 72, 501) ;
delete from expandable_field_maps ;
delete from field_config_links ;


-----GRID STATE Configuration-------------
insert into configurations(id, config_key, value) values(configurations_seq.nextval, 'GRID_STATE', '0' );

-----LCH related configs for Rule-------------
insert into configurations(id, config_key, value) values(configurations_seq.nextval, 'MAX_RULE_RETENTION_WO_SUMM_IN_DAYS', '370' );
insert into configurations(id, config_key, value) values(configurations_seq.nextval, 'GRANULE_TIME_BEYOND_MAX_RETENTION_IN_HRS', '6' );

--Record Types--
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter, category,is_partitioned,is_cost_computation_enabled,is_spark_support,is_distributed_cache) values(3,'SUBSCRIBER','Subscriber',0,'PHONE_NUMBER',1, '|', 'NAMED_FILTERS PRECHECK RULE_TAGS STATS_RULE_ENTITY_TYPE FINGERPRINT_RULE_ENTITY_TYPE INLINE_RULES TEST_RULE',0,0,0,0) ;
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter, category,is_partitioned,is_cost_computation_enabled,is_spark_support,is_distributed_cache) values(4,'ACCOUNT','Account',0,'ACCOUNT_NAME',1, ',', 'NAMED_FILTERS RULE_TAGS STATS_RULE_ENTITY_TYPE INLINE_RULES TEST_RULE',0,0,0,0) ; 
...
insert into record_configs (id, tname, description, cacheable, key, is_visible, category) values(16,'ARCHIVED_ALARMS_V','Archived Alarms',0,'ID',1,'NAMED FILTERS') ;
...
insert into record_configs (id, tname, description, cacheable, key, is_visible) values(20,'ARCHIVED_ALERTS_V','Archived Alerts',0,'ID',0) ;
...
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter, category) values(36,'CASE_ALARM_VIEWS','Alarms and Archived Open Cases',0,'ID',1, ',', '') ;
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter,category) values(37,'CASE_ALARM_VIEWS','Closed Cases Alarms',0,'ID',1, ',','') ;
...
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter, category) values(98,'PRECHECK_SUBSCRIBER','Subscriber Precheck List',0,'PHONE_NUMBER',1, '|', '') ;
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter, category) values(99,'PRECHECK_ACCOUNT','Account Precheck List',0,'ACCOUNT_NAME',1, ',', '') ;


-- SDR Rate --
insert into record_configs (id, tname, description, cacheable, key, is_visible,category) values(85,'SDR_RATE_V','SDR Rates',0,'',1,'NAMED_FILTERS');
...
--  Customer Alert Rule Management ---
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter, category) values(244,'CUSTOMER_ALERT_RULES_V','Customer Alert Rules',0,'',1, '|', 'NAMED_FILTERS') ;
--  *************** ---
--  Customer Notifications ---
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter, category) values(245,'CUSTOMER_NOTIFICATIONS','Customer Notifications',0,'',1, '|', 'NAMED_FILTERS') ;
--  *************** ---
...
-- Rate Per Call --
insert into record_configs (id, tname, description, cacheable, key, is_visible,category) values(59, 'RATE_PER_CALLS','Rates Per Call', 0, '', 1,'NAMED_FILTERS') ;
...
insert into record_configs (id, tname, description, cacheable, key, is_visible) values(69,'OBS_SUMMARY_RECORDS','Observation Summary Records', 0, '', 0) ;
...
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_cell_specific, is_primary_view, is_logging_enabled) values(15,'Hotlist Values',15,'HOTLIST_KEY_ID = 0','MODIFIED_DATE DESC', 1, 0, 1, 1, 1) ;
...
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_cell_specific, is_primary_view, is_logging_enabled) values(26,'Alarms',36,'','MODIFIED_DATE DESC', 1, 0,1, 1, 0) ;
...
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_cell_specific, is_primary_view, is_logging_enabled) values(38,'Call To Call By Phone Number',27,'','ID ASC', 1, 0, 0, 1, 1) ;
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible, is_primary_view) values(40,'Named Filters',32,'NAME IS NOT NULL AND CATEGORY LIKE ''%NAMED_FILTER%''','ID ASC', 1, 0, 0) ;
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible, is_primary_view) values(139,'Named Filters',32,'NAME IS NOT NULL AND CATEGORY LIKE ''%NAMED_QUERY_FILTER%''','ID ASC', 1, 0, 0) ;
...
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_primary_view) values(45,'Subscriber Precheck List',98, '','ID ASC', 1, 1, 0) ;
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_primary_view) values(46,'Account Precheck List',99, '','ID ASC', 1, 1, 0) ;
...
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_cell_specific, is_primary_view, is_logging_enabled) values(50,'Case Closed Alarms',37,'STATUS IN (2,4)','MODIFIED_DATE DESC', 1, 0,1, 0, 0) ;
...
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible, is_primary_view) values(44,'View Inactive Autothreshold', 35, '', 'THRESHOLD_MODIFIED_DATE DESC', 1, 1, 1) ;
...
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible, is_cell_specific, is_primary_view) values(52,'Rules',44,'RULE_MODE=0 AND IS_ACTIVE = 1 AND (CATEGORY NOT IN (''CUSTOMER ALERT RULE'',''FINGERPRINT_RULE'',''INLINE_RULES'',''STATISTICAL_RULE'', ''STATISTICAL_ONLINE'') OR CATEGORY IS NULL)','KEY ASC', 1, 0,0, 1) ;
...
-- Record View Configs for Customer Rule Management --
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_cell_specific, is_primary_view,is_logging_enabled) values(252,'Customer Alert Rules',244,'','KEY ASC', 1, 0,0, 1, 1) ;

-- **************************************** --
-- FieldConfigs for Customer Alert Rule Management - Rule --

insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id) values (field_configs_seq.nextval, 244, 'ID', 'ID', 0, 0, 1, 1) ;
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter,	width, reg_exp_id) values (field_configs_seq.nextval, 244, 'Rule Name', 'NAME', 1, 1, 3, 2, 1, 41,14) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id) values (field_configs_seq.nextval, 244, 'KEY', 'KEY', 0, 0, 1, 4) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, translation_id, is_filter) values (field_configs_seq.nextval, 244, 'Data Streams', 'DATA_STREAMS', 3, 1, 7, 5, 705, 1) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, translation_id, is_filter) values (field_configs_seq.nextval, 244, 'Aggregate On', 'AGGREGATION_TYPE', 4, 1, 1, 6, 706, 1) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, translation_id, is_filter) values (field_configs_seq.nextval, 244, 'Function', 'FUNCTION', 5, 1, 1, 7, 707, 1) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, translation_id) values (field_configs_seq.nextval, 244, 'Network', 'NETWORK_ID', 6, 0, 7, 11, 10) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, translation_id, is_filter, reg_exp_id) values (field_configs_seq.nextval, 244, 'Status', 'STATUS', 7, 1, 3, 8, 105, 1, 10) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id,translation_id, is_filter, reg_exp_id) values (field_configs_seq.nextval, 244, 'User', 'USERNAME', 8, 1, 3, 9, 107, 1, 10) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id) values (field_configs_seq.nextval, 244, 'Description', 'DESCRIPTION', 0, 1, 3, 12) ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 244, '11') ;

-- Record View Configs for Customer Notifications --
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible, is_cell_specific, is_primary_view) values(253,'Customer Notifications',245,'','START_TIME DESC', 1, 0, 1, 1) ;
-- **************************************** --
-- FieldConfigs for Customer Alert Rule Management - Rule --

insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id) values (field_configs_seq.nextval, 245, 'ID', 'ID', 0, 0, 1, 1) ;
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, width)	values (field_configs_seq.nextval, 245, 'Ref Id', 'REFERENCE_ID', 1, 0, 3, 2, 40) ;
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter,	width, reg_exp_id, translation_id) values (field_configs_seq.nextval, 245, 'Aggregation Type', 'AGGREGATION_TYPE', 2, 1, 3, 3, 1, 40, 13, 706) ;
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, width,is_expandable, is_filter,reg_exp_id) values (field_configs_seq.nextval, 245, 'Aggregation Value', 'AGGREGATION_VALUE', 3, 1, 3, 4, 40, 1, 1,19) ;
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter,	width,translation_id, is_expandable) values (field_configs_seq.nextval, 245, 'Rule Name', 'RULE_KEY', 4, 1, 1, 5, 1, 41, 708, 1) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter,	translation_id)	values (field_configs_seq.nextval, 245, 'Alert Type', 'ALERT_TYPE', 5, 1, 3, 6, 1, 704) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id) values (field_configs_seq.nextval, 245, 'Threshold Value', 'VALUE', 6, 1, 2, 7) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id) values (field_configs_seq.nextval, 245, 'Sms Text', 'SMS_TEXT', 7, 1, 3, 8) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id) values (field_configs_seq.nextval, 245, 'Email Subject', 'EMAIL_SUBJECT', 8, 1, 3, 9) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id) values (field_configs_seq.nextval, 245, 'Email Text', 'EMAIL_TEXT', 9, 1, 3, 10) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id) values (field_configs_seq.nextval, 245, 'Start Time', 'START_TIME', 10, 1, 4, 11) ;
insert into field_config_links(id,source_view_id,source_key,link,destn_key) values (101,253,'RULE_KEY','customer_alert_rule','RULE_KEY') ;
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type,	category) values (3001, 'Notification-Subscriber', 253, 'AGGREGATION_VALUE', 3, 'PHONE_NUMBER', 0, 2, 'RECORD_VIEW');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type,	category) values (3002, 'Notification-IMSI-Subscriber', 253, 'AGGREGATION_VALUE', 3, 'IMSI', 0, 4, 'RECORD_VIEW');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type,	category) values (3003, 'Notification-UserName-Subscriber', 253, 'AGGREGATION_VALUE', 3, 'PHONE_NUMBER', 0, 225, 'RECORD_VIEW');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type,	category) values (3004, 'Notification-AccName-Account', 253, 'AGGREGATION_VALUE', 4, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW');

insert into bulk_data_view_configs values (253,'7,11',100000);
...
-- Rate Per Calls --
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_cell_specific, is_primary_view) values(70,'Rates Per Call',59, '','ID ASC', 1, 0, 0, 1) ;
...
-- Observation Summary Records--
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_cell_specific, is_primary_view) values(82,'Observation Summary Records', 69, '', 'SUMMARY_START_TIME DESC', 1, 1, 1, 1) ;
...
insert into record_view_configs (id, name, record_config_id, order_by, is_pagination_enabled, is_visible, is_primary_view,
	is_logging_enabled) values (107, 'SDR Rates', 85, 'ID ASC', 1, 1, 1, 1) ;
...
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (148, 3, 'Phone Number', 'PHONE_NUMBER', 13, 0, 1, 'GR', 3,'', 12, '', null, 1, 40, 31, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (149, 3, 'Date of Activation of Service', 'SUBSCRIBER_DOA', 14, 0, 1, 'SMM.PRECHECK', 4,'', 13, '', null, 1, 11, null, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (150, 3, 'Home Phone Number', 'HOME_PHONE_NUMBER', 15, 0, 1, 'SMM.PRECHECK GR', 3,'', 14, '', null, 1, 40, 1, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (151, 3, 'Office Phone Number', 'OFFICE_PHONE_NUMBER', 16, 0, 1, 'SMM.PRECHECK GR', 3,'', 15, '', null, 1, 40, 1, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (152, 3, 'Contact Phone Number', 'CONTACT_PHONE_NUMBER', 17, 0, 1, 'SMM.PRECHECK GR', 3,'', 16, '', null, 1, 40, 1, null, null) ;
...
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (155, 3, 'IMSI', 'IMSI', 20, 0, 1, 'SMM.PRECHECK GR', 3,'', 19, '', null, 1, 40, 9, null, null) ;
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (156, 3, 'IMEI', 'IMEI', 21, 0, 1, 'SMM.PRECHECK GR', 3,'', 20, '', null, 1, 40, 9, null, null) ;
...
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Service Number Type', 'SERVICE_NUMBER_TYPE', '38', 0, 1, 'GR', 1, null, 53, null, 721, 1, 20,0, null, null, null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'SSID', 'SSID', '0', 0, 0, 'GR CR', 8, null, 54, null, null, 0, 20,0, null, '37', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Subscriber UID', 'SUBSCRIBER_UID', '39', 1, 1, 'GR CR', 3, null, 55, null, null, 1, 40,0, null, null, null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Date of Activation of Subscriber', 'SUBSCRIBER_UID_DOA', '40', 0, 1, null, 4, null, 56, null, null, 1, 20,0, null, null, null, 0, 0) ;

insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Is Update', 'IS_UPDATE', 0, 0, 0, null, 1, null, 78, null, null, 0, 2,0, null, 14, null, 0, 0) ;

insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'ID Number', 'ID_NUMBER', '41', 0, 1, null, 8, null, 57, null, null, 1, 20,0, null, null, null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Dealer Name', 'DEALER_NAME', '42', 0, 1, null, 3, null, 58, null, null, 1, 256,10, null, null, null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Date of Birth', 'DATE_OF_BIRTH', '43', 0, 1, null, 4, null, 59, null, null, 1, 256,10, null, null, null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Current Balance', 'CURRENT_BALANCE', '44', 0, 1, null, 2, null, 60, null, null, 1, 20,0, null, null, null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'File name', 'FILE_NAME', '45', 0, 1, null, 3, null, 61, null, null, 1, 256,10, null, null, null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'DS Name', 'DS_NAME', '46', 0, 1, null, 3, null, 62, null, null, 1, 256,10, null, null, null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 1', 'OPTIONAL_FIELD_1', '47', 0, 1, null, 3, null, 63, null, null, 1, 256,10, null, '', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 2', 'OPTIONAL_FIELD_2', '48', 0, 1, null, 3, null, 64, null, null, 1, 256,10, null, '', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 3', 'OPTIONAL_FIELD_3', '49', 0, 1, null, 3, null, 65, null, null, 1, 256,10, null, '', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 4', 'OPTIONAL_FIELD_4', '50', 0, 1, null, 3, null, 66, null, null, 1, 256,10, null, '', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 5', 'OPTIONAL_FIELD_5', '51', 0, 1, null, 3, null, 67, null, null, 1, 256,10, null, '', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 6', 'OPTIONAL_FIELD_6', '52', 0, 1, null, 3, null, 68, null, null, 1, 256,10, null, '', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 7', 'OPTIONAL_FIELD_7', '53', 0, 1, null, 3, null, 69, null, null, 1, 256,10, null, '', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 8', 'OPTIONAL_FIELD_8', '54', 0, 1, null, 3, null, 70, null, null, 1, 256,10, null, '', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 9', 'OPTIONAL_FIELD_9', '55', 0, 1, null, 3, null, 71, null, null, 1, 256,10, null, '', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 10', 'OPTIONAL_FIELD_10', '56', 0, 1, null, 3, null, 72, null, null, 1, 256,10, null, '', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 11', 'OPTIONAL_FIELD_11', '57', 0, 1, null, 2, null, 73, null, null, 1, 16, '', null, '', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 12', 'OPTIONAL_FIELD_12', '58', 0, 1, null, 2, null, 74, null, null, 1, 16, '', null, '', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 13', 'OPTIONAL_FIELD_13', '59', 0, 1, null, 2, null, 75, null, null, 1, 16, '', null, '', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 14', 'OPTIONAL_FIELD_14', '60', 0, 1, null, 4, null, 76, null, null, 1, 256, '', null, '', null, 0, 0) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,3, 'Optional Field 15', 'OPTIONAL_FIELD_15', '61', 0, 1, null, 4, null, 77, null, null, 1, 256, '', null, '', null, 0, 0) ;


------------Account Information
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (163, 3, 'Rate Plan', '', 28, 0, 1, 'CMM.STATIC.RULE CMM.DYNAMIC.RULE', 3,'', 27, '', null, 1, 256, 8, '5.13', null) ;
...
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (208, 4, 'Rate Plan', 'RATE_PLAN', 13, 0, 1, 'CMM.STATIC.RULE CMM.DYNAMIC.RULE GR', 3,'', 13, '', null, 1, 256, 8, null, null) ;
...
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (2012, 12, 'Rate Plan', 'RATE_PLAN', 13, 0, 1, 'CMM.STATIC.RULE CMM.DYNAMIC.RULE GR', 3,'', 13, '', null, 1, 256, 8, null, 19) ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (506, 8, 'Action', 'ACTION', 7, 6, 3, 0, '', '', 20, null, 1, 10, 1) ;
...
insert into field_configs_additionals values (field_configs_additionals_seq.nextval, 4, 8, 'LIVE_TREE_COMPONENT', 1) ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (425, 10, 'Duration', 'DURATION',26,19,8,0,'','',40,9,0,24,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (426, 10,'Upload Volume', 'UPLOAD_VOLUME',27,20,2,0,'','',40,null,0,24,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (427, 10, 'Download Volume', 'DOWNLOAD_VOLUME',28,21,2,0,'','',40,null,0,24,1,'') ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval,2080,10,'22') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval,2081,10,'23') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval,2082,10,'24') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval,2083,10,'25') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 12, 10, '26') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 50, 10, '27') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 49, 10, '28') ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function,associated_field, live_tree_ds) values  (481, 21, 'Rule Name','RULE_IDS',22,18,7,0,'','',256,69,0,null,1,'','', 'Rule.get_livetree_for_rule') ;
...
insert into field_configs_additionals values (field_configs_additionals_seq.nextval, 24, 21, 'LIVE_TREE_COMPONENT', 1) ;
insert into field_configs_additionals values (field_configs_additionals_seq.nextval, 22, 21, 'LIVE_TREE_COMPONENT', 1) ;
...
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,21, 'Service Number Type', 'SERVICE_NUMBER_TYPE', 32, 0, 1, 'GR', 1, null, 33, null, 720, 1, 20,0, null, null, null, 0, 0) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values (field_configs_seq.nextval, 21, 'Duration', 'DURATION',34,19,8,0,'','',40,9,0,13,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values (field_configs_seq.nextval, 21, 'Upload Volume', 'UPLOAD_VOLUME',35,20,2,0,'','',40,null,0,13,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values (field_configs_seq.nextval, 21, 'Download Volume', 'DOWNLOAD_VOLUME',36,21,2,0,'','',40,null,0,13,1,'') ;


insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 12, 21, '34') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 50, 21, '35') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 49, 21, '36') ;
-----------------Field Configs for Open Case Alarm ----------------------
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Network','NETWORK_ID',1,1,1,0,'','',40,'10',(select decode(count(*),1,0,1) from networks),null,1,'' ) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Id', 'ID',2,0,1,0,'','',40,null,0,null,0,'18') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Reference ID', 'REFERENCE_ID',3,2,8,0,'','',40,null,0,null,0,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Case Name', 'CASE_ID',4,0,1,0,'','',40,34,1,16,1,'15') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Alert Count', 'ALERT_COUNT',5,3,1,0,'','',40,null,1,13,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Created Date','CREATED_DATE',6,4,4,0,'','',40,null,1,null,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Modified Date','MODIFIED_DATE',7,5,4,0,'','',40,null,1,null,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Status', 'STATUS',8,6,1,0,'GR CR','',40,26,1,null,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Owner', 'USER_ID',9,0,3,0,'','',64,514,1,16,1,'16') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Score', 'SCORE',10,0,1,0,'GR CR','',40,null,1,13,1,'17') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Value', 'VALUE',11,7,2,0,'GR CR','',40,null,1,12,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Record Count', 'CDR_COUNT',12,8,1,0,'','',40,null,1,13,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Reference Type', 'REFERENCE_TYPE',14,10,1,0,'','',40,42,1,null,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Reference Value', 'REFERENCE_VALUE',15,11,3,1,'','',40,null,1,25,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Is Visible', 'IS_VISIBLE',16,12,6,0,'','',40,null,0,null,0,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Account Name','ACCOUNT_NAME',18,14,3,0,'','',256,null,1,8,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Subscriber Name','SUBSCRIBER_NAME',19,15,3,0,'','',256,null,1,8,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Subscriber Groups','GROUPS',20,16,7,0,'','',256,27,1,null,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Outstanding Amount','OUTSTANDING_AMOUNT',36,17,2,0,'','',256,null,1,null,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function,associated_field, live_tree_ds) values  (field_configs_seq.nextval, 36, 'Rule Name','RULE_IDS',22,18,7,0,'','',256,69,0,null,1,'','', 'Rule.get_livetree_for_rule') ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function,associated_field,live_tree_ds) values  (field_configs_seq.nextval, 36, 'Rule Tags','RULE_TAGS',24,0,9,0,'','',256,61,0,null,0,'','','Tag.get_tag_set_for_rule') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Owner Type', 'OWNER_TYPE',25,0,1,0,'','',20,93,0,null,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values (field_configs_seq.nextval, 36, 'Pending Time','PENDING_TIME',26,0,4,0,'','',40,null,1,null,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'First Assigned/Investigated Time', 'ASSIGNED_DATE', 27, 0, 4, 0, '', '', 40, null, 1, null, 1, '');
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Alarm Analysis Time', 'ANALYSIS_DURATION', 28, 0, 1, 0, '', '', 40, 9, 1, null, 1, '');
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Workflow Assigned Time', 'WF_ASSIGNED_DATE', 29, 0, 4, 0, '', '', 40, null, 1, null, 1, '');
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Workflow Modified Time', 'WF_MODIFIED_DATE', 30, 0, 4, 0, '', '', 40, null, 1, null, 1, '');
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 36, 'Team', 'TEAM',31,31,3,0,'','',64,710,1,null,1,'16');
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, translation_id) values (field_configs_seq.nextval, 36, 'Is Archived', 'IS_ARCHIVED', 0, 1, 6, 32, 6) ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,36, 'Service Number Type', 'SERVICE_NUMBER_TYPE', 32, 0, 1, 'GR', 1, null, 37, null, 720, 1, 20,0, null, null, null, 0, 0) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values (field_configs_seq.nextval, 36, 'Duration', 'DURATION',38,33,8,0,'','',40,9,0,13,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values (field_configs_seq.nextval, 36, 'Upload Volume', 'UPLOAD_VOLUME',39,34,2,0,'','',40,null,0,13,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values (field_configs_seq.nextval, 36, 'Download Volume', 'DOWNLOAD_VOLUME',40,35,2,0,'','',40,null,0,13,1,'') ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 12, 36, '38') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 50, 36, '39') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 49, 36, '40') ;

-----------------Field Comfigs for Closed Alarms ------------------------
insert into field_configs (select field_configs_seq.nextval, 37, name, database_field, position, is_expandable, is_visible,ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive from field_configs where record_config_id = 36 and database_field not like 'PENDING_TIME' and database_field not like 'RULE_IDS' and database_field not like 'FRAUD_TYPES') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function,associated_field) values  (field_configs_seq.nextval, 37, 'Closure Type','DISPLAY_VALUE',17,13,3,0,'','',119,119,1,10,1,'','') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function,associated_field, live_tree_ds) values  (field_configs_seq.nextval, 37, 'Rule Name','RULE_IDS',22,18,7,0,'','',256,69,0,null,0,'','', 'Rule.get_livetree_for_rule') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 37, 'Declared Fraud Value', 'DECLARED_FRAUD_VALUE', 33, 0, 2, 0, '', '', 20, null, 1, null, 0, '');
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function,associated_field) values  (field_configs_seq.nextval, 37, 'Fraud Types','FRAUD_TYPES',23,0,7,0,'','',256,60,1,'',1,'','') ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function,associated_field, live_tree_ds) values  (5420,16, 'Rule Name','RULE_IDS',21,0,7,0,'','',256,69,0,null,0,'','', 'Rule.get_livetree_for_rule') ;
...
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,16, 'Service Number Type', 'SERVICE_NUMBER_TYPE', 32, 0, 1, 'GR', 1, null, 32, null, 720, 1, 20,0, null, null, null, 0, 0) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values (field_configs_seq.nextval,16, 'Duration', 'DURATION',33,16,8,0,'','',40,9,0,13,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values (field_configs_seq.nextval,16, 'Upload Volume', 'UPLOAD_VOLUME',34,17,2,0,'','',40,null,0,13,1,'') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values (field_configs_seq.nextval,16, 'Download Volume', 'DOWNLOAD_VOLUME',35,18,2,0,'','',40,null,0,13,1,'') ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 12, 16, '33') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 50, 16, '34') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 49, 16, '35') ;


insert into field_configs_additionals values (field_configs_additionals_seq.nextval, 23, 16, 'LIVE_TREE_COMPONENT', 1) ;
insert into field_configs_additionals values (field_configs_additionals_seq.nextval, 21, 16, 'LIVE_TREE_COMPONENT', 1) ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter, live_tree_ds) values  (432, 11, 'Rule Name', 'EVENT_INSTANCE_ID',3,3,1,1,'','',40,69,1,13,1, 'Rule.get_livetree_for_rule') ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter, live_tree_ds) values  (446, 11, 'Rule Tags', 'RULE_TAGS',18,18,9,0,'','',256,61,0,null,0,'Tag.get_tag_set_for_rule') ;
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,11, 'Service Number Type', 'SERVICE_NUMBER_TYPE', 19, 0, 1, 'GR', 1, null, 19, null, 720, 1, 20,0, null, null, null, 0, 0) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (field_configs_seq.nextval, 11, 'Duration', 'DURATION',20, 19,8,0,'','',40,9,0,13,1) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (field_configs_seq.nextval, 11,'Upload Volume', 'UPLOAD_VOLUME',21, 20,2,0,'','',40,null,0,13,1) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (field_configs_seq.nextval, 11,'Download Volume', 'DOWNLOAD_VOLUME',22, 21,2,0,'','',40,null,0,13,1) ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 12, 11, '20') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 50, 11, '21') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 49, 11, '22') ;

insert into field_configs_additionals values (field_configs_additionals_seq.nextval, 18, 11, 'LIVE_TREE_COMPONENT', 1) ;
insert into field_configs_additionals values (field_configs_additionals_seq.nextval, 3, 11, 'LIVE_TREE_COMPONENT', 1) ;
...
insert into field_configs (id, record_config_id, name, database_field, position, is_expandable, is_visible, ds_category, data_type, format, field_id, query_field, translation_id, is_filter, width, reg_exp_id, associated_field, derivative_function, live_tree_ds, is_encrypted, is_case_sensitive) values (field_configs_seq.nextval,20, 'Service Number Type', 'SERVICE_NUMBER_TYPE', 16, 0, 1, 'GR', 1, null, 16, null, 720, 1, 20,0, null, null, null, 0, 0) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (field_configs_seq.nextval, 20, 'Duration', 'DURATION',17, 16,8,0,'','',40,9,1,13,0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (field_configs_seq.nextval, 20, 'Upload Volume', 'UPLOAD_VOLUME',18, 17,2,0,'','',40,null,0,13,0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (field_configs_seq.nextval, 20, 'Download Volume', 'DOWNLOAD_VOLUME',19, 18,2,0,'','',40,null,0,13,0) ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 12, 20, '17') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 50, 20, '18') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 49, 20, '19') ;
...
insert into field_record_config_maps(ID,FIELD_CATEGORY_ID,RECORD_CONFIG_ID,FIELD_ASSOCIATION) values(FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,5,97,'1');
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter, reg_exp_id)  values(field_configs_seq.nextval,85,'Network', 'NETWORK', 2, 0, 7, 0, '','', null, 10, 0, 1, '');
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format,  is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (field_configs_seq.nextval, 26, 'Subscriber ID','SUBSCRIBER_ID',12,12,8, '', 0,'','',20,null,0,null,0) ; 
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 22, 'Team', 'TEAM',31,31,3,0,'','',64,710,1,null,1,'16');
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function,associated_field, live_tree_ds) values  (field_configs_seq.nextval, 23, 'Rule Name','RULE_IDS',22,18,7,0,'','',256,69,0,null,0,'','', 'Rule.get_livetree_for_rule') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 23, 'Declared Fraud Value', 'DECLARED_FRAUD_VALUE', 31, 0, 2, 0, '', '', 20, null, 1, null, 0, '');
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function,associated_field) values  (field_configs_seq.nextval, 23, 'Fraud Types','FRAUD_TYPES',23,0,7,0,'','',256,60,1,'',1,'','') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 23, 'Team', 'TEAM',32,31,3,0,'','',64,710,1,null,1,'16');

insert into field_configs_additionals values (field_configs_additionals_seq.nextval, 22, 23, 'LIVE_TREE_COMPONENT', 1) ;
insert into field_configs_additionals values (field_configs_additionals_seq.nextval, 24, 23, 'LIVE_TREE_COMPONENT', 1) ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 24, 'Team', 'TEAM',31,31,3,0,'','',64,710,1,null,1,'16');

insert into field_configs_additionals values (field_configs_additionals_seq.nextval, 22, 24, 'LIVE_TREE_COMPONENT', 1) ;
insert into field_configs_additionals values (field_configs_additionals_seq.nextval, 24, 24, 'LIVE_TREE_COMPONENT', 1) ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format,  is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values	(field_configs_seq.nextval, 27, 'Phone Number','PHONE_NUMBER',1,1,3, '', 0,'','',20,null,0,null,0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format,  is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values	(field_configs_seq.nextval, 27, 'Date Of Activation','DOA',2,6,4, '', 0,'','',20,null,0,null,0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format,  is_expandable,ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (field_configs_seq.nextval,	27, 'Subscriber ID','SUBSCRIBER_ID',3,7,8, '', 0,'','',20,null,0,null,0) ; 
...
insert into field_configs (id, record_config_id, name, database_field, field_id, position, data_type, format,  is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values (field_configs_seq.nextval, 32, 'Description','DESCRIPTION',4,4,3, '', 0,'','',4000,null,0,9,0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format,  is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (field_configs_seq.nextval, 32, 'Owner','USER_ID',5,5,3, '', 0,'','',20,23,1,null,1) ; 
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format,  is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (field_configs_seq.nextval, 32, 'Is Shared','IS_SHARED',6,6,1, '', 0,'','',20,6,1,null,1) ; 
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format,  is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (2650, 33, 'Rule Network ID', 'NETWORK_ID', 6, 6, 7, '', 0, '', '', 20, 10, 0, null, 1) ; 
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format,  is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (4001, 40, 'User Name','USER_NAME',2,2,3, '', 0,'','',64,161,1,10,1) ; 
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format,  is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (4003, 40, 'Default Role','DEFAULT_ROLE',4,4,3, '', 0,'','',20,160,1,0,1) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format,  is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (4004, 40, 'Networks','NETWORK',5,5,7, '', 0,'','',20,10,0,null,1) ;
...
--insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format,  is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (4014, 40, 'Password Validity (days)','DAYS_TO_EXPIRE',15,15,1, 1, 0,'','',20,109,1,null,1) ; 
...
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, translation_id) values (3028, 44, 'Network', 'NETWORK_ID', 6, 0, 7, 11, 10) ; 
...
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, translation_id, is_filter) values (3067, 46, 'Network', 'NETWORK_ID', 5, 0, 7, 6, 10, 0) ; 
...
insert into field_configs (id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, is_visible, is_filter, reg_exp_id, derivative_function) values (3046, 47, 'Job Name', 'JOB_NAME', 2, 1, 3, 0, '', '', 256, 1, 1, 0, '');
...
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter, reg_exp_id, translation_id) values (3055, 47, 'Network', 'NETWORK', 9, 0, 7, 10, 0, 0, 515) ;
...
insert into field_record_config_maps(ID,FIELD_CATEGORY_ID,RECORD_CONFIG_ID,FIELD_ASSOCIATION)
	        values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,5,110,'10'); 
...
insert into field_record_config_maps(ID,FIELD_CATEGORY_ID,RECORD_CONFIG_ID,FIELD_ASSOCIATION) 
		values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,74,50,'2');
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, 
			is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter, reg_exp_id)  
		values 
			(field_configs_seq.nextval, 52, 'Network', 'NETWORK', 3, 0, 7, 0, '', '', null, 10, 0, 1, '') ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, 
			is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter, reg_exp_id)  
		values 
			(field_configs_seq.nextval, 52, 'Is Repeatable Action', 'IS_REPEATABLE_ACTION', 5, 0, 1, 0, '', '', null, 6, 1, 1, 0) ;
-- Free Numbers---
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, 
			is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter, reg_exp_id)  
		values 
			(field_configs_seq.nextval, 53, 'Network', 'NETWORK', 3, 3, 7, 0, '', '', null, 10, 0, 1, null) ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 54, 'Network', 'NETWORK', 15, 15, 7, 0, '', '', null, 10, 0, 1, '') ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format, is_expandable,ds_category, query_field, width, is_visible, reg_exp_id, is_filter) values (field_configs_seq.nextval, 61,'Modification Time','MODIFICATION_TIME',4,3,4, '', 0,'','',50,1,null,1) ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id, width)  values (field_configs_seq.nextval, 55, 'Network', 'NETWORK_ID', 5, 1, 7, 0, 0, 1, 0, 10, 10) ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id, width)  values (field_configs_seq.nextval, 56, 'Network', 'NETWORK_ID', 4, 0, 7, 0, 0, 0, 0, 10, 10) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 56, 'Recurring', 'IS_REPETITIVE', 5, 0, 3, 0, 1, 1, 0, 6) ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id, width)  values (field_configs_seq.nextval, 68, 'Network', 'NETWORK_ID', 8, 7, 1, 0, 0, 0, 0, 10, 20) ;

-- Observation Summary Records --
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable,	is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 69, 'Aggregation Type', 'AGGREGATION_TYPE', 1, 2, 1, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable,	is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 69, 'Aggregation Value', 'AGGREGATION_VALUE', 2,	3, 3, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 69, 'Alert ID', 'ALERT_ID', 3, 4, 1, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable,	is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 69, 'Summary Start Time', 'SUMMARY_START_TIME', 4, 5, 4, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, ds_category)  values (field_configs_seq.nextval, 69, 'Summary End Time', 'SUMMARY_START_TIME', 5, 6, 4, 0, 1, 1, 0, 'GR END TYM') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 69, 'Record Config ID', 'RECORD_CONFIG_ID', 6, 7, 1, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 69, 'Count', 'COUNT', 7, 8, 1, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 69, 'Value', 'VALUE', 8, 9, 2, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, ds_category)  values (field_configs_seq.nextval, 69, 'Accumulated Value', 'MEASURING_DATA', 9, 10, 3, 0, 1, 1, 0, 'GR ACCM VAL') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 69, 'CDR ID', 'CDR_ID', 10, 11, 1, 0, 0, 0, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 69, 'Rule Name', 'RULE_KEY', 11, 1, 1, 1, 1, 0, 0, 69) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 69, 'ID', 'ID', 12, 0, 1, 0, 0, 0, 0) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 69, 'Duration', 'DURATION', 13, 12, 8, 0, 0, 1, 0, 9) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 69, 'Upload Volume', 'UPLOAD_VOLUME', 14, 13, 2, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 69, 'Download Volume', 'DOWNLOAD_VOLUME', 15, 14, 2, 0, 0, 1, 0) ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 12, 69, '13') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 50, 69, '14') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 49, 69, '15') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 12, 22, '34') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 50, 22, '35') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 49, 22, '36') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 12, 23, '34') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 50, 23, '35') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 49, 23, '36') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 12, 24, '34') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 50, 24, '35') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 49, 24, '36') ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id, width)  values (field_configs_seq.nextval, 81, 'Network', 'NETWORK_ID', 4, 3, 7, 0, 0, 0, 0, 10, 10) ;
...
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,  5, 81, '4') ;
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category, data_record_type)
	values (520, 'Account Details', 45, 'ACCOUNT_ID', 46, 'ID', 0, 1, 'RECORD_VIEW GR STR RULE', 0);
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (521, 'Account Subscriber Details', 46, 'ID', 45, 'ACCOUNT_ID', 0, 24, 'RECORD_VIEW');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (522, 'Account Credit Details', 46, 'ACCOUNT_NAME', 5, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW GR RULE');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (523, 'Account Credit Details', 46, 'ID', 5, 'ACCOUNT_ID', 0, 7, '');

--For SubscriberStore
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category)
	values (524, 'Previous Subscriber Details', 45, 'PHONE_NUMBER', 21, 'PHONE_NUMBER', 0, 9999, '') ;
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category)
	values (525, 'Previous Blacklisted Details', 45, 'PHONE_NUMBER, ACCOUNT_NAME', 12, 'PHONE_NUMBER, ACCOUNT_NAME', 0, 9999, '') ;
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category)
	values (526, 'Previous Account Details', 45, 'ACCOUNT_NAME', 22, 'ACCOUNT_NAME', 0, 9999, '') ;
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category)
	values (527, 'Previous Blacklisted Account Details', 45, 'ACCOUNT_NAME', 13, 'ACCOUNT_NAME', 0, 9999, '') ;
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category)
	values (3005, 'Previous Subscriber Details', 3, 'SUBSCRIBER_UID', 21, 'SUBSCRIBER_UID', 0, 9999, '') ;
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (58, 'Service-ActiveAccount', 3, 'ACCOUNT_NAME', 4, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (59, 'Subscriber-Black Listed Account', 3, 'ACCOUNT_NAME', 13, 'ACCOUNT_NAME', 0, 7, '');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (60, 'Account-ActiveService', 4, 'ACCOUNT_NAME', 3, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (61, 'Account-Black Listed Service', 4, 'ACCOUNT_NAME', 12, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (169, 'Account-Disconnected Service', 4, 'ACCOUNT_NAME', 105, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW');

--Subscriber - Account Info
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (528, 'Service-ActiveAccount', 45, 'ACCOUNT_NAME', 46, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (529, 'Subscriber-Black Listed Account', 45, 'ACCOUNT_NAME', 13, 'ACCOUNT_NAME', 0, 7, '');
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (116, 'BlackListService-BlackListAccount', 12, 'ACCOUNT_NAME', 13, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (124, 'BlackListService-ActiveAccount', 12, 'ACCOUNT_NAME', 4, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (170, 'BlackListService-ActiveAccount', 12, 'ACCOUNT_ID', 22, 'ID', 0, 8, '');

--Disconnected Subscriber - Account Info
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category)
       values (166, 'DisconnectedService-ActiveAccount', 105, 'ACCOUNT_NAME', 4, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW') ;
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category)
       values (167, 'DisconnectedService-BlackListAccount', 105, 'ACCOUNT_NAME', 13, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW') ;
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (533, 'Subscriber-BlackListAccount', 45, 'ACCOUNT_ID', 13, 'ID', 0, 1, '');


insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (135, 'Service-ActiveAccount', 21, 'ACCOUNT_NAME', 4, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW RULE');
--BlackList Account

insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (122, 'BlackListAccount-BlackListServices', 13, 'ACCOUNT_NAME', 12, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW');
...
insert into expandable_field_maps values (159, 'Alarm-AccountName-Subscriber', 96, 'REFERENCE_ID', 4, 'ID', 3, 0,
	'RECORD_VIEW', 0) ;
insert into expandable_field_maps values (160, 'Alarm-Service', 96, 'REFERENCE_VALUE,REFERENCE_ID', 3, 'PHONE_NUMBER,ID', 999, 0,
	'RECORD_VIEW', 0) ;
...
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,  2, 3, '12') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,  3, 3, '20') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,  4, 3, '19') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,  5, 3, '3') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,  6, 3, '23') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,  7, 3, '5.1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 16, 3, '32') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 24, 3, '35') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 26, 3, '13') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 30, 3, '24') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 31, 3, '25') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 32, 3, '33') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 29, 3, '22') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 203, 3, '5.20') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 48, 3, '13') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 42, 3, '28') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 42, 4, '14') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 43, 3, '30') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 43, 4, '16') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 13, 3, '39') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 13, 4, '36') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 13, 12, '32') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 1, 3, '32') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 1, 4, '19') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 183, 3, '5.7') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 184, 3, '5.8') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 185, 3, '5.9') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 186, 3, '5.10') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 204, 3, '1') ;
insert into field_record_config_maps(ID,FIELD_CATEGORY_ID,RECORD_CONFIG_ID,FIELD_ASSOCIATION) values(FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,70,3,39);
insert into field_record_config_maps(ID,FIELD_CATEGORY_ID,RECORD_CONFIG_ID,FIELD_ASSOCIATION) values(FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,225,3,12);
insert into field_record_config_maps (id, record_config_id, field_category_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 3.0, 6009, '53') ;
insert into field_record_config_maps (id, record_config_id, field_category_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 3.0, 6010, '54') ;
insert into field_record_config_maps (id, record_config_id, field_category_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 3.0, 6011, '55') ;
insert into field_record_config_maps (id, record_config_id, field_category_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 3.0, 6012, '56') ;
insert into field_record_config_maps (id, record_config_id, field_category_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 3.0, 6015, '3005.54') ;

--For Subscriber Store
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 57, 3, '20.32') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 58, 3, '22.19') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 2067, 3, '20.35') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 2068, 3, '170.171.32') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 116, 3, '42') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 6003, 3, '47') ;

--active account
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 106, 4, '25.26.30') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 107, 4, '25.30') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 113, 4, '25.31') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 108, 4, '30.26.19') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 110, 4, '30.19') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 111, 4, '30.31') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 114, 4, '29.31') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 114, 3, '22.31') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 115, 3, '22.30') ;
--


insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 59, 3, '20.31') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 60, 3, '21.32') ;


insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 61, 3, '23.19') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 62, 3, '34') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 62, 4, '35') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 63, 3, '5.17') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 64, 3, '26') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 64, 4, '50') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 65, 3, '5.18') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 66, 3, '5.21') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 66, 4, '21') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 67, 3, '31') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 67, 4, '34') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 77, 3, '5.19') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 78, 3, '36') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 78, 4, '33') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 79, 3, '29') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 79, 4, '15') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 80, 3, '37') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 82, 3, '20.1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 83, 3, '20') ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 24, 4, '19') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 29, 4, '5.20') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 6004, 4, '53') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 203, 4, '20') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 4, '3') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 33, 4, '4') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 34, 4, '5') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 35, 4, '6') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 183, 4, '7') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 184, 4, '8') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 185, 4, '9') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 186, 4, '10') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 63, 4, '17') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 48, 4, '2') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 32, 4, '29') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 7, 4, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 65, 4, '18') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 199, 3, '21') ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 8, '11') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 2, 4, '60.12') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 16, 4, '60.32') ;

--Entried For alarms
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5,  10, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 1,  10, '2') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 75, 10, '3') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 69, 10, '5') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 84, 10, '6') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 70, 10, '7') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 67, 10, '8') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 71, 10, '10') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 17, 10, '11') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 72, 10, '12') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 73, 10, '14') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 74, 10, '15') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 68, 10, '16') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 33, 10, '50.5.4') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 34, 10, '50.5.5') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 35, 10, '50.5.6') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 86, 10, '18') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 87, 10, '14') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 88, 10, '15') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 183, 10, '65.7') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 184, 10, '65.8') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 186, 10, '65.10') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 78, 10, '65.15.3') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 2073, 10, '65.11') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 2074, 10, '65.15.8') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 2075, 10, '65.15.10') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 2078, 10, '20') ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 11, '17') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 29, 14, '14.2') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 15, '8') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 16, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 7, 16, '17') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 17, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 21, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 7, 21, '18') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 17, 21, '11');
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 22, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 7, 22, '18') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 23, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 7, 23, '18') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 24, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 7, 24, '18') ;

--Entries for Invalid Subscriber Counter
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 2, 28, '2') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 13, 28, '4') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 28, '115.3') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 24, 28, '115.35') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 16, 28, '115.32') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 73, 28, '3') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 74, 28, '2') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 75, 28, '1') ;

-- Entries for Auto Suspect Numbers --
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 2, 26, '2') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 16, 26, '12');

-- Entries for Called To Called By Phone Number --
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 2, 27, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 26, 27, '2') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 26, 26, '11');
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 16, 27, '3');


insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 31, '8') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 33, '6') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 40, '5') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 49, '5') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 43, '8') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 44, '11') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 46, '6') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 41, '6') ;
...
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 13, 51, '4') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 51, '5') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 2, 51, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 73, 51, '3') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 74, 51, '2') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 75, 51, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 212, 51, '1') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 01, 51, '1') ;


-- Entries for Analyst Actions
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 52, '3') ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 212, 3, '32') ;

-- Entries for Free Numbers
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 53, '3') ;

-- Entries for Special Numbers
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 54, '15') ;
...
insert into field_configs(id, record_config_id, name, database_field, is_expandable, is_visible, data_type, field_id, is_filter, translation_id) values (field_configs_seq.nextval, 77, 'Network(s)', 'NETWORK', 0, 0, 7, 6, 1, 10) ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 77, '6') ;
...
insert into field_configs(id, record_config_id, name, database_field, is_expandable, is_visible, data_type, field_id, is_filter, translation_id) values (field_configs_seq.nextval, 90, 'Network(s)', 'NETWORK', 0, 0, 7, 4, 1, 10) ;

-- Team
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 90, '4') ;

-- Distance Time
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 55, '5') ;

-- Holiday List
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 56, '4') ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 47, '10') ;

-- Cell Site GEO
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) 
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 68, '8') ;

-- Alarm
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 215, 10, '9') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 2, 10, '15') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association)
	values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 2070, 10, '19') ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, 
		query_field, width, translation_id, is_visible, reg_exp_id, is_filter) 
	values  (field_configs_seq.nextval, 78, 'Network', 'NETWORKS', 5, 5, 7, 0, '', '', 1024, 10, 0, null, 1) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, 
		query_field, width, translation_id, is_visible, reg_exp_id, is_filter) 
	values  (field_configs_seq.nextval, 78, 'Priority', 'PRIORITY', 6, 6, 1, 0, '', '', 20, null, 1, null, 1) ;

insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter, width, reg_exp_id, translation_id) values (field_configs_seq.nextval, 78, 'Status', 'STATUS', 7, 1, 3, 8, 1, 41, 10, 105) ; 
	

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,  5, 78, '5') ;
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type) values (expandable_field_maps_seq.nextval, 'Disconnected Subscriber Details', 95, 'REFERENCE_VALUE',105, 'PHONE_NUMBER', 0, 1) ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, 
		query_field, width, translation_id, is_visible, reg_exp_id, is_filter) 
	values  (field_configs_seq.nextval, 80, 'Network', 'NETWORKS', 6, 6, 7, 0, '', '', 1024, 10, 0, null, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, 
...
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter, width, reg_exp_id, translation_id) values (field_configs_seq.nextval, 80, 'Status', 'STATUS', 8, 1, 3, 8, 1, 41, 10, 105) ; 

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,  5, 80, '6') ;
...
insert into field_record_config_maps values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 82, 2) ;
---------------------------------------------------ENTRIES For Suspect Fingerprints-------------------------
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,	is_primary_view, is_logging_enabled) values (100,'Suspect eFingerprints',3,' (((ID > 1024 AND ACCOUNT_ID > 1024) AND SUBSCRIBER_TYPE = 0 AND STATUS IN (1,2,3)) OR (ID> 1024 AND SUBSCRIBER_TYPE = 1 AND (ACCOUNT_ID > 1024 OR ACCOUNT_ID = 4))) AND id in (select distinct fp.profiled_entity_id from fp_suspect_profiles_16 fp where fp.IS_MATCH_TYPE = 1 and fp.entity_id = 2)','MODIFIED_DATE DESC', 1, 1, 0, 1) ;
insert into record_view_configs values (101, 'Accounts',4,'(ID > 1024) AND (ACCOUNT_TYPE IN (0,1))','MODIFIED_DATE DESC',0,0,0,0,0,0,0,'') ;

insert into expandable_field_maps (id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type,
	category, data_record_type)values (163, 'Subscriber-Account', 100, 'ACCOUNT_NAME',	101, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW RULE', 0) ;
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (191, 'Account-ActiveService', 103, 'ACCOUNT_NAME', 3, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (192, 'Account-Black Listed Service', 103, 'ACCOUNT_NAME', 12, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) 
	values (193, 'Account-Disconnected Service', 103, 'ACCOUNT_NAME', 105, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW');

---------------Expandables for auto suspect numbers-----------------
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (228, 'Subscriber Details', 36, 'PHONE_NUMBER,SUBSCRIBER_ID',  102, 'PHONE_NUMBER,ID', 0, 2, 'RULE') ;

--------------Expandables for call to call by numbers--------------------
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (229, 'Subscriber Details', 38, 'PHONE_NUMBER,SUBSCRIBER_ID',  102, 'PHONE_NUMBER,ID', 0, 2, 'RULE') ;

---------  Expandables in Hotlist entity (Phone Number for blacklist subscriber )

insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (expandable_field_maps_seq.nextval, 'Phone Number Blacklist Subscriber', 15, 'VALUE', 12, 'PHONE_NUMBER', 0, 2, 'RECORD_VIEW NOT_VISIBLE');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type,
...
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 85, '2') ;


--Entries for Hotlist Keys
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,  5, 92, '5') ;
 

--for unique record sequence ID in multipl_field_counter for count changes
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5000, 3, '38') ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5000, 4, '37') ;


-- Total Calls
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,  220, 3 , '43') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,  222, 3 , '20.43') ;
...
insert into field_configs values (field_configs_seq.nextval, 86, 'Network', 'NETWORKS', 6, 0, 0, null, 7, null, 6, null, 10, 1, 4000, null, null, null, null, 0,0) ;

insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_visible, is_cell_specific, is_pagination_enabled, is_primary_view, is_logging_enabled) values (108,'Account Groups', 86, 'CATEGORY = 1', 'ID ASC', 1, 0, 1, 0, 0 ) ;
insert into field_record_config_maps values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 86, 6) ;
...
insert into field_configs values (field_configs_seq.nextval, 87, 'Group Name', 'KEY', 2, 0, 1, null, 3, null, 2, null, null, 1, 30, 28, null, null, null, 0,0) ; 
...
insert into field_configs values (field_configs_seq.nextval, 87, 'Network', 'NETWORK_ID', 6, 0, 0, null, 7, null, 6, null, 10, 1, 4000, null, null, null, null, 0,0) ;
insert into field_configs (id,record_config_id,name,database_field,position,is_expandable,is_visible,data_type,field_id,reg_exp_id,is_filter,width) values (field_configs_seq.nextval,87,'User Name', 'USER_NAME',8,0,1,3,8,9,1,256);
insert into field_configs (id,record_config_id,name,database_field,position,is_expandable,is_visible,data_type,field_id,is_filter) values (field_configs_seq.nextval,87,'Created Time', 'CREATED_TIME',9,0,1,4,9,1);
insert into field_configs (id,record_config_id,name,database_field,position,is_expandable,is_visible,data_type,field_id,is_filter) values (field_configs_seq.nextval,87,'Modified Time', 'MODIFIED_TIME',10,0,1,4,10,1);
insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_visible, is_cell_specific, is_pagination_enabled, is_primary_view, is_logging_enabled) values (109,'Subscriber Groups', 87, 'CATEGORY = 1', 'ID ASC', 1, 0, 1, 0, 0 ) ;
insert into field_record_config_maps values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 87, 6) ;

---------------------------------Entries for modified Account/Subscriber grouping rules View---------------
insert into record_configs (id, tname, description, cacheable, key, is_visible,category) values(88,'ACC_SUB_GROUPING_RULES_V','Account Grouping Rule',0,'ID',1, 'NAMED_FILTERS' ) ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 88, '4') ;
...
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter, width, reg_exp_id, translation_id) values (field_configs_seq.nextval, 88, 'Networks', 'NETWORKS', 0, 0,  7,  4, 1, 10,	0,10) ;
...
---------------------------------Entries for modified Account/Subscriber grouping rules View---------------
insert into record_configs (id, tname, description, cacheable, key, is_visible,category) values(89,'ACC_SUB_GROUPING_RULES_V','Subscriber Grouping Rule',0,'ID',1, 'NAMED_FILTERS' ) ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 89, '4') ;
...
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter,	width, reg_exp_id, translation_id) values (field_configs_seq.nextval, 89, 'Networks', 'NETWORKS', 0, 0,  7, 4, 1, 10, 0, 10) ;
...
-------------------------------------Entries For modified Account/Subscriber Notification Groups Views--------------------------------
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter, category, is_partitioned) values
(125, 'ACTIVE_ACC_SUB_NOTF_GROUPS_V','Notification Groups', 0, 'ID', 1, null, 'NAMED_FILTERS' , 0) ;

insert into field_configs values (field_configs_seq.nextval, 125, 'Group ID', 'ID', 1, 0, 0, null, 1, null, 1, null, null, 0, 20, null, null, null, null, 0,0) ; 
insert into field_configs values (field_configs_seq.nextval, 125, 'Group Name', 'KEY', 2, 0, 1, null, 3, null, 2, null, null, 1, 30, 9, null, null, null, 0,0) ; 
insert into field_configs values (field_configs_seq.nextval, 125, 'Description', 'DESCRIPTION', 3, 0, 1, null, 3, null, 3, null, null, 1, 256, 10, null, null, null, 0,0) ; 
insert into field_configs values (field_configs_seq.nextval, 125, 'Priority', 'PRIORITY', 4, 0, 1, null, 1, null, 4, null, null, 1, 20, null, null, null, null, 0,0) ; 
insert into field_configs values (field_configs_seq.nextval, 125, 'Entity Type', 'RECORD_CONFIG_ID', 5, 0, 1, null, 1, null, 5, null, 85 , 1, 20, null, null, null, null, 0,0) ; 
insert into field_configs values (field_configs_seq.nextval, 125, 'Network', 'NETWORKS', 7, 0, 0, null, 7, null, 6, null, 10, 1, 4000, null, null, null, null, 0,0) ;

insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_visible, is_cell_specific,
	is_pagination_enabled, is_primary_view, is_logging_enabled) values (342,'Notification Groups', 125, null, 'ID ASC', 1, 0, 1, 0, 0 ) ;
insert into field_record_config_maps values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 125, 6) ;
-----------------------------------------------------Case Comment View-------------------------------------------------------
insert into record_configs (ID,TNAME,DESCRIPTION,CACHEABLE,KEY,IS_VISIBLE,DELIMETER,CATEGORY) values(131,'CASE_COMMENTS','Comments',0,null,1,'','');

insert into field_configs (id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter)  values (field_configs_seq.nextval, 131, 'ID', 'ID',0,0,8, 0, '', '', 255, null, 0,0) ;
insert into field_configs (id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter)  values (field_configs_seq.nextval, 131, 'Comment', 'CASE_COMMENT',1,0,3, 0, '', '', 255, null, 1,0) ;
insert into field_configs (id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter)  values (field_configs_seq.nextval, 131, 'User', 'USER_ID',2,1,3, 0, '', '', 255, 125, 1,0) ;
insert into field_configs (id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter)  values (field_configs_seq.nextval, 131, 'Date', 'COMMENT_DATE',3,2,4, 0, '', '', 255, null, 1,0) ;

insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible, is_primary_view, is_logging_enabled) values (350,'Case Comments',131,'id>0','ID DESC',1,1,1,1);

-----------------------------------------------------Case Attachment View-------------------------------------------------------
insert into record_configs (ID,TNAME,DESCRIPTION,CACHEABLE,KEY,IS_VISIBLE,DELIMETER,CATEGORY) values(132,'CASE_ATTACHMENTS','Case Attachments',0,null,1,'','');

insert into field_configs (id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter)  values (field_configs_seq.nextval, 132, 'ID', 'ID',0,0,8, 0, '', '', 255, null, 0,0) ;
insert into field_configs (id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter)  values (field_configs_seq.nextval, 132, 'File Name', 'FILE_NAME',1,0,3, 0, '', '', 255, null, 1,0) ;
insert into field_configs (id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter)  values (field_configs_seq.nextval, 132, 'User', 'USER_ID',2,1,3, 0, '', '', 255, 125, 1,0) ;
insert into field_configs (id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, is_filter)  values (field_configs_seq.nextval, 132, 'Date', 'ATTACHMENT_DATE',3,2,4, 0, '', '', 255, null, 1,0) ;

insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible, is_primary_view, is_logging_enabled) values (351,'Case Attachements',132,'id>0','ID DESC',1,1,1,1);

---------------------------------Entries for modified Account/Subscriber Notification Grouping rules View---------------
insert into record_configs (id, tname, description, cacheable, key, is_visible,category) values(301,'ACC_SUB_NOTF_GROUPING_RULES_V','Notification Grouping Rule',0,'ID',1, 'NAMED_FILTERS' ) ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values
(FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 5, 301, '4') ;
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter,
	width, reg_exp_id) values (field_configs_seq.nextval, 301, 'Rule Name', 'RULE_NAME', 0, 1,  3,  1, 1, 10, 14) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter,
	width, reg_exp_id, translation_id) values (field_configs_seq.nextval, 301, 'Groups', 'SUBSCRIBER_GROUP', 0, 1,  7,  2, 1, 10, 0,701) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter,
	width, reg_exp_id, translation_id) values (field_configs_seq.nextval, 301, 'Action', 'ACTION_NAME', 0, 1,  3,  3, 1, 10, 0, 101) ;
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter,
	width, reg_exp_id, translation_id) values (field_configs_seq.nextval, 301, 'Entity Type', 'RECORD_CONFIG_ID', 0, 1, 1, 7, 1, 20, null, 85) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter,
	width, reg_exp_id, translation_id) values (field_configs_seq.nextval, 301, 'Networks', 'NETWORKS', 0, 0,  7,  4, 1, 10, 0, 10) ;
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter,
	width, reg_exp_id) values (field_configs_seq.nextval, 301, 'ID', 'ID', 0, 0,  1,  5, 0, 10, 0) ;

insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled,
	is_visible,is_cell_specific, is_primary_view) values(143, 'Notification Grouping Rules',301,null,'ID DESC', 1, 1, 0, 1) ;
-------------------------------------Entries For Customer Alert Template view--------------------------------
insert into record_configs (id, tname, description, cacheable, key, is_visible, delimeter, category, is_partitioned) values
(129, 'CUSTOMER_ALERT_TEMPLATES','Notification Templates', 0, 'ID', 1, null, '' , 0) ;

insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter,
	width, reg_exp_id) values (field_configs_seq.nextval, 129, 'Template Name', 'NAME', 0, 1,  3,  1, 1, 10, 14) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter,
	width, reg_exp_id, translation_id) values (field_configs_seq.nextval, 129, 'Alert Type', 'ALERT_TYPE', 1, 1, 3, 2, 1, 10, 0,704) ; 
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, is_filter, width, reg_exp_id) values (field_configs_seq.nextval, 129, 'ID', 'ID', 0, 0,  1,  5, 0, 10, 0) ;

insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_visible, is_cell_specific,
	is_pagination_enabled, is_primary_view, is_logging_enabled) values (145,'Notification Templates', 129, null, 'ID ASC', 1, 0, 1, 0, 0 ) ;

-- Archived Observation Summary Records--
insert into record_configs (id, tname, description, cacheable, key, is_visible) values(93,'AR_OBS_SUMMARY_RECORDS','Archived Observation Summary Records', 0, '', 0) ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, ds_category)  values (field_configs_seq.nextval, 93, 'Summary End Time', 'SUMMARY_START_TIME', 5, 5, 4, 0, 1, 1, 0, 'GR END TYM') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 93, 'Record Config ID', 'RECORD_CONFIG_ID', 6, 6, 1, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 93, 'Count', 'COUNT', 7, 7, 1, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 93, 'Value', 'VALUE', 8, 8, 2, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, ds_category)  values (field_configs_seq.nextval, 93, 'Accumulated Value', 'MEASURING_DATA', 9, 9, 3, 0, 1, 1, 0, 'GR ACCM VAL') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 93, 'CDR ID', 'CDR_ID', 10, 10, 1, 0, 0, 0, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 93, 'Rule Name', 'RULE_KEY', 11, 1, 1, 1, 1, 0, 0, 69) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 93, 'ID', 'ID', 12, 0, 1, 0, 0, 0, 0) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 93, 'Duration', 'DURATION', 13, 11, 8, 0, 1, 1, 0,9) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 93, 'Upload Volume', 'UPLOAD_VOLUME', 14, 12, 2, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 93, 'Download Volume', 'DOWNLOAD_VOLUME', 15, 13, 2, 0, 0, 1, 0) ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 12, 93, '13') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 50, 93, '14') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 49, 93, '15') ;


insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_cell_specific, is_primary_view) values(117,'Archived Observation Summary Records', 93, '', 'SUMMARY_START_TIME DESC', 1, 1, 1, 1) ;
...
insert into record_configs (id, tname, description, cacheable, key, is_visible) values(172,'OBS_SUMMARY_RECORDS','Observation Summary Records', 0, '', 0) ;
...
insert into translation_indices values (1557, 'Stats Obs Summary Rule Name', null, 1);
insert into translations values (translations_seq.nextval, 1557, '-176', 'select key as Key, substr(name, 1, instr(name, ''_Profile_Field_v'')-1) as Value from rules r where is_active = 1 and (category like ''%PROFILE_FIELD%'') and parent_id != 0 and id > 1024 and rule_mode=0') ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable,is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 172, 'Statistical Element','RULE_KEY', 9, 9, 1, 1, 1, 1, 0,1557) ;
...
insert into record_configs (id, tname, description, cacheable, key, is_visible) values(173,'AR_OBS_SUMMARY_RECORDS','Archived Observation Summary Records', 0, '', 0) ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable,	is_visible, is_filter, reg_exp_id, translation_id) values  (field_configs_seq.nextval, 173, 'Statistical Element','RULE_KEY',9, 9, 1, 1, 1, 1, 0, 1557) ;
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (205, 'Alarm-Service', 118, 'REFERENCE_VALUE,REFERENCE_ID', 3, 'PHONE_NUMBER,ID', 0, 999, 'RECORD_VIEW');
...
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 2079, 3, '20.20') ;

-- Bill Cycle Relations
insert into field_record_config_maps(id,field_category_id,record_config_id,field_association) values(FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,901,3,'226.16');
...
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type, category) values (16, 'Account Recharge Details', 4, 'ACCOUNT_NAME', 6, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW GR RULE');
insert into expandable_field_maps(id, name, source_view_id, source_key, dest_view_id, dest_key, is_new_view, dest_key_type,
	category)	values (540, 'Account Recharge Details', 46, 'ACCOUNT_NAME', 6, 'ACCOUNT_NAME', 0, 7, 'RECORD_VIEW GR RULE');
...
iNSERT INTO field_configs (id,record_config_id,name,database_field,position,field_id,data_type,is_expandable,is_visible,ds_category,format,query_field,translation_id,width,reg_exp_id,associated_field,is_filter,derivative_function,live_tree_ds,is_encrypted,is_case_sensitive) values (field_configs_seq.nextval,111,'Days to expiry','NO_OF_DAYS',2,3,1,0,0,null,null,null,null,40,null,null,0,null,null,0,0);
...
insert into field_configs (id,record_config_id,name,database_field,position,field_id,data_type,is_expandable,is_visible,ds_category,format,query_field,translation_id,width,reg_exp_id,associated_field,is_filter,derivative_function,live_tree_ds,is_encrypted,is_case_sensitive) values (field_configs_seq.nextval,111,'Description','DESCRIPTION',7,8,3,0,1,null,null,null,null,256,0,null,1,null,null,0,0);

insert into field_record_config_maps (id,field_category_id,record_config_id,field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,1,111,'5');
iNSERT INTO field_record_config_maps (id,field_category_id,record_config_id,field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,5,111,'2');

---- Customer Alerts
insert into field_record_config_maps (id,field_category_id,record_config_id,field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,36,3,'14');
insert into field_record_config_maps (id,field_category_id,record_config_id,field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,37,3,'15');
insert into field_record_config_maps (id,field_category_id,record_config_id,field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,38,3,'16');
insert into field_record_config_maps (id,field_category_id,record_config_id,field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,38,3,'46');
insert into field_record_config_maps (id,field_category_id,record_config_id,field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,38,4,'52');
insert into field_record_config_maps (id,field_category_id,record_config_id,field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,5003,3,'45');
insert into field_record_config_maps (id,field_category_id,record_config_id,field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,5003,4,'51');
...
insert into field_configs (id,record_config_id,name,database_field,position,field_id,data_type,is_expandable,is_visible,ds_category,format,query_field,translation_id,width,reg_exp_id,associated_field,is_filter,derivative_function,live_tree_ds,is_encrypted,is_case_sensitive) values (field_configs_seq.nextval,112,'Network','NETWORK_ID',4,4,7,0,0,null,null,null,515,300,0,null,1,null,null,0,0);
...
insert into field_record_config_maps (id,field_category_id,record_config_id,field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,5,112,'4');
insert into field_record_config_maps (id,field_category_id,record_config_id,field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval,1,112,'1');
...
------------- Customer Alert fields cust_alert_email , cust_alert_contact_number for Subscriber and account ----------------------
insert into field_configs
(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function)
	values (field_configs_seq.nextval, 3, 'Subscriber Customer Alert Email Id', 'CUST_ALERT_EMAIL_ID', 34, 0, 1,'SMM.PRECHECK GR' , 3,'', 45, '', null, 1, 256, 22, null, null) ;
	
insert into field_configs
(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (field_configs_seq.nextval, 3, 'Subscriber Customer Alert Contact Number','CUST_ALERT_CONTACT_NUMBER', 35, 0,	1,'SMM.PRECHECK GR', 3,'', 46, '', null, 1, 40, 1, null, null) ;

insert into field_configs (id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (field_configs_seq.nextval, 4, 'Account Customer Alert Email Id', 'CUST_ALERT_EMAIL_ID', 21, 0, 1,'SMM.PRECHECK GR' , 3,'', 51, '', null, 1, 256, 22, null, null) ;
	
insert into field_configs (id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (field_configs_seq.nextval, 4, 'Account Customer Alert Contact Number', 'CUST_ALERT_CONTACT_NUMBER', 22, 0, 1,'SMM.PRECHECK GR' , 3,'', 52, '', null, 1, 40, 1, null, null) ;

insert into field_configs
(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (field_configs_seq.nextval, 3, 'Account Customer Alert Email Id', '', 36, 0, 0,'SMM.PRECHECK', 3,'', 51, '', null, 1, 256, 22,'5.51', null) ;

insert into field_configs
(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (field_configs_seq.nextval, 3, 'Account Customer Alert Contact Number', '', 37, 0, 0,'SMM.PRECHECK' , 3,'', 52,'', null, 1, 40, 1,'5.52', null) ;

insert into
field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (field_configs_seq.nextval, 3, 'Notification Groups', 'NOTIFICATION_GROUPS', 33, 0, 1, 'GR', 7,'', 47, '', 702, 1, 256, null, null, null) ;
insert into
field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id,associated_field,derivative_function) values (field_configs_seq.nextval, 4, 'Notification Groups', 'NOTIFICATION_GROUPS', 23, 0, 1, 'GR', 7, '', 53, '', 703, 1, 256, null, null, null) ;
commit;


---- Record Config for the statistical rule granular info

insert into translation_indices(id, description, is_dynamic) values (557,'Statistical Rule Element Name',1) ;
insert into translations(id, tr_id, key, value) values (translations_seq.nextval, 557, '-176', 'select rule_key as  Key, name as Value from FP_ELEMENTS pf where pf.rule_key = rule_key' ) ;

insert into translation_indices(id, description) values (548, 'Data Stream for profile fields') ;
insert into translations(id, tr_id, key, value) values (translations_seq.nextval, 548, '-176', 'select id as Key, description as Value from record_configs rc where rc.category like ''%PROFILE_FIELD%'' and rc.id = id' ) ;

insert into record_configs (id, tname, description, cacheable, key, is_visible) values(120,'OBS_SUMMARY_RECORDS','Granular Element Records',0,'',0) ;

insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_cell_specific, is_primary_view) values(203,'Granular Element Records', 120, '', 'SUMMARY_START_TIME DESC', 1, 1, 1, 1) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 120, 'Alert ID', 'ALERT_ID', 10, 9, 1, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 120, 'Element Name', 'RULE_KEY', 1, 1, 1, 1, 1, 0, 0, 557) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 120, 'Data Stream', 'RECORD_CONFIG_ID', 2, 2, 1, 0, 1, 1, 0, 548) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 120, 'Summary Start Time', 'SUMMARY_START_TIME', 3, 3, 4, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, ds_category)  values (field_configs_seq.nextval, 120, 'Summary End Time', 'SUMMARY_START_TIME', 4, 4, 4, 0, 1, 1, 0, 'GR END TYM') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 120, 'Count', 'COUNT', 5, 5, 1, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 120, 'Value', 'VALUE', 6, 6, 2, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, ds_category)  values (field_configs_seq.nextval, 120, 'Accumulated Value', 'MEASURING_DATA', 7, 7, 3, 0, 1, 1, 0, 'GR ACCM VAL') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 120, 'Aggregation Type', 'AGGREGATION_TYPE', 8, 8, 1, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 120, 'ID', 'ID', 9, 0, 1, 0, 0, 0, 0) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 120, 'Duration', 'DURATION', 11, 9, 8, 0, 0, 1, 0 ,9) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 120, 'Upload Volume', 'UPLOAD_VOLUME', 12, 10, 2, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 120, 'Download Volume', 'DOWNLOAD_VOLUME', 13, 11, 2, 0, 0, 1, 0) ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 12, 120, '11') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 50, 120, '12') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 49, 120, '13') ;

insert into field_config_links(id,source_view_id,source_key,link,destn_key) values (10,203,'RULE_KEY','fp_element','RULE_KEY') ;
insert into configurations(id, config_key, value) values(configurations_seq.nextval, 'STATISTICAL_GRANULAR_INTERVAL', '6' );

insert into field_configs_additionals values(field_configs_additionals_seq.nextval, 6, 120, 'IS_CURRENCY' ,1) ;

insert into configurations(id, config_key, value) values(configurations_seq.nextval, '1.EXPANDABLE.LOOKBACK', '3');
insert into configurations(id, config_key, value) values(configurations_seq.nextval, '7.EXPANDABLE.LOOKBACK', '3');
insert into configurations(id, config_key, value) values(configurations_seq.nextval, '2.EXPANDABLE.LOOKBACK', '3');
insert into configurations(id, config_key, value) values(configurations_seq.nextval, '83.EXPANDABLE.LOOKBACK', '3');


---- Record Config for the statistical rule archived granular info

insert into record_configs (id, tname, description, cacheable, key, is_visible) values(121,'AR_OBS_SUMMARY_RECORDS','Archived Granular Element Records',0,'',0) ;

insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_cell_specific, is_primary_view) values(204,'Archived Granular Element Records', 121, '', 'SUMMARY_START_TIME DESC', 1, 1, 1, 1) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 121, 'Alert ID', 'ALERT_ID', 10, 9, 1, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 121, 'Element Name', 'RULE_KEY', 1, 1, 1, 1, 1, 0, 0, 557) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 121, 'Data Stream', 'RECORD_CONFIG_ID', 2, 2, 1, 0, 1, 1, 0, 548) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 121, 'Summary Start Time', 'SUMMARY_START_TIME', 3, 3, 4, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, ds_category)  values (field_configs_seq.nextval, 121, 'Summary End Time', 'SUMMARY_START_TIME', 4, 4, 4, 0, 1, 1, 0, 'GR END TYM') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 121, 'Count', 'COUNT', 5, 5, 1, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 121, 'Value', 'VALUE', 6, 6, 2, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, ds_category)  values (field_configs_seq.nextval, 121, 'Accumulated Value', 'MEASURING_DATA', 7, 7, 3, 0, 1, 1, 0, 'GR ACCM VAL') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 121, 'Aggregation Type', 'AGGREGATION_TYPE', 8, 8, 1, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 121, 'ID', 'ID', 9, 0, 1, 0, 0, 0, 0) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 121, 'Duration', 'DURATION', 11, 9, 8, 0, 0, 1, 0, 9) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 121, 'Upload Volume', 'UPLOAD_VOLUME', 12, 10, 2, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 121, 'Download Volume', 'DOWNLOAD_VOLUME', 13, 11, 2, 0, 0, 1, 0) ;

insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 12, 121, '11') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 50, 121, '12') ;
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (field_record_config_maps_seq.nextval, 49, 121, '13') ;

insert into field_config_links(id,source_view_id,source_key,link,destn_key) values (11,204,'RULE_KEY','fp_element','RULE_KEY') ;

insert into field_configs_additionals values(field_configs_additionals_seq.nextval, 6, 121, 'IS_CURRENCY' ,1) ;

---- Record Config for smart pattern  rules with statistical/summary rule block participating records

insert into translation_indices(id, description, is_dynamic) values (558,'SP Statistical Rule Block Element Name',1) ;
insert into translations(id, tr_id, key, value) values (translations_seq.nextval, 558, '-176', 'select rule_key as  Key, name as Value from FP_ELEMENTS pf where pf.rule_key = rule_key' ) ;

insert into translation_indices(id, description, is_dynamic) values (559,'SP Blocks Rule Name',1) ;
insert into translations(id, tr_id, key, value) values (translations_seq.nextval, 559, '-176', 'select id as  Key, name as Value from rules r where r.id = id' ) ;

insert into translation_indices(id, description) values (551,'Data Stream (duplicate)') ;
insert into translations(id, tr_id, key, value) values (translations_seq.nextval, 551, '-176', 'select id as Key, description as Value from record_configs rc where rc.category like ''%PROFILE_FIELD%'' and rc.id = id' ) ;

insert into record_configs (id, tname, description, cacheable, key, is_visible) values(122,'SMART_PATTERN_BLOCK_RECORDS','Smart Pattern Summarized Participating Records',0,'',0) ;

insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_cell_specific, is_primary_view) values(205,'SP Summary Participating Records', 122, '', 'RECORD_TIME DESC', 1, 1, 1, 1) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 122, 'Alert Data ID', 'ALERT_DATA_ID', 10, 10, 1, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 122, 'Rule Name', 'RULE_ID', 1, 1, 1, 1, 1, 0, 0, 559) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 122, 'Element Name', 'RULE_KEY', 2, 2, 1, 1, 1, 0, 0, 558) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 122, 'Data Stream', 'RECORD_CATEGORY', 3, 3, 1, 0, 1, 1, 0, 551) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, ds_category)  values (field_configs_seq.nextval, 122, 'Summary Start Time', 'RECORD_TIME', 4, 4, 4, 0, 1, 1, 0, 'SP GR START TYM') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, ds_category)  values (field_configs_seq.nextval, 122, 'Summary End Time', 'RECORD_TIME', 5, 5, 4, 0, 1, 1, 0, 'GR END TYM') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 122, 'Count', 'RECORD_COUNT', 6, 6, 1, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 122, 'Value (' ||(select value from configurations where  config_key like '%CURRENCY%') || ')', 'RECORD_VALUE', 7, 7, 2, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, ds_category)  values (field_configs_seq.nextval, 122, 'Accumulated Value', 'MEASURING_DATA', 8, 8, 3, 0, 1, 1, 0, 'GR ACCM VAL') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 122, 'ID', 'ID', 9, 0, 1, 0, 0, 0, 0) ;

insert into field_config_links(id,source_view_id,source_key,link,destn_key) values (12,205,'RULE_KEY','fp_element','RULE_KEY') ;
insert into field_config_links(id,source_view_id,source_key,link,destn_key) values (13,205,'RULE_ID','rule','RULE_ID') ;
--insert into configurations(id, config_key, value) values(configurations_seq.nextval, 'SP_BLOCK_GRANULARITY', '3600' );

--------------Record Config for Archived smart pattern  rules alerts with statistical/summary rule block participating records

insert into record_configs (id, tname, description, cacheable, key, is_visible) values(123,'AR_SMART_PATTERN_BLOCK_RECORDS','Archived Smart Pattern Summarized Participating Records',0,'',0) ;

insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_cell_specific, is_primary_view) values(206,'Archived SP Summary Participating Records', 123, '', 'RECORD_TIME DESC', 1, 1, 1, 1) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 123, 'Alert Data ID', 'ALERT_DATA_ID', 10, 10, 1, 0, 0, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 123, 'Rule Name', 'RULE_ID', 1, 1, 1, 1, 1, 0, 0, 559) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 123, 'Element Name', 'RULE_KEY', 2, 2, 1, 1, 1, 0, 0, 558) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, translation_id)  values (field_configs_seq.nextval, 123, 'Data Stream', 'RECORD_CATEGORY', 3, 3, 1, 0, 1, 1, 0, 551) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, ds_category)  values (field_configs_seq.nextval, 123, 'Summary Start Time', 'RECORD_TIME', 4, 4, 4, 0, 1, 1, 0, 'SP GR START TYM') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, ds_category)  values (field_configs_seq.nextval, 123, 'Summary End Time', 'RECORD_TIME', 5, 5, 4, 0, 1, 1, 0, 'GR END TYM') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 123, 'Count', 'RECORD_COUNT', 6, 6, 1, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 123, 'Value (' ||(select value from configurations where  config_key like '%CURRENCY%') || ')', 'RECORD_VALUE', 7, 7, 2, 0, 1, 1, 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id, ds_category)  values (field_configs_seq.nextval, 123, 'Accumulated Value', 'MEASURING_DATA', 8, 8, 3, 0, 1, 1, 0, 'GR ACCM VAL') ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, is_visible, is_filter, reg_exp_id)  values (field_configs_seq.nextval, 123, 'ID', 'ID', 9, 0, 1, 0, 0, 0, 0) ;

insert into field_config_links(id,source_view_id,source_key,link,destn_key) values (14,206,'RULE_KEY','fp_element','RULE_KEY') ;
insert into field_config_links(id,source_view_id,source_key,link,destn_key) values (15,206,'RULE_ID','rule','RULE_ID') ;
-- End Record Config for smart pattern statistical/summary rules participating records
...
insert into field_configs(id,record_config_id,name,database_field,position,is_expandable,is_visible,ds_category,data_type,format,field_id,query_field,translation_id,is_filter,width,reg_exp_id) values (field_configs_seq.nextval, 113, 'Notification Status', 'NOTIFICATION_STATUS', 10, 0, 0, '', 3,'', 11, '', '', 1, 40, 10) ;
...
insert into field_configs(id, record_config_id, name, database_field, position, is_visible, data_type, field_id, translation_id) values (field_configs_seq.nextval, 116, 'Status', 'STATUS', 6, 1, 3, 8, 105) ; 
...
insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,8,69,'IS_CURRENCY',1);
insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,8,93,'IS_CURRENCY',1);
...
insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,22,22,'LIVE_TREE_COMPONENT',1);
insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,24,22,'LIVE_TREE_COMPONENT',1);
...
insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,1,17,'IS_EDITABLE',0);

insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,1,17,'IS_MANDATORY',1);

insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,2,17,'IS_EDITABLE',1);

insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,2,17,'IS_MANDATORY',1);

insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,3,17,'IS_EDITABLE',1);

insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,9,17,'IS_EDITABLE',1);

insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,9,17,'IS_MANDATORY',1);
...
insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,53,3,'IS_MANDATORY',1);
insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,55,3,'IS_MANDATORY',1);
insert into FIELD_CONFIGS_ADDITIONALS(ID,FIELD_ID,RECORD_CONFIG_ID,CONFIG_KEY,VALUE) values (FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,56,3,'IS_MANDATORY',1);
...
insert into field_configs_additionals values(FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,53,3,'IS_NOT_MODIFIABLE',1);
insert into field_configs_additionals values(FIELD_CONFIGS_ADDITIONALS_SEQ.nextval,55,3,'IS_NOT_MODIFIABLE',1);
...
insert into field_record_config_maps(id, field_category_id, record_config_id, field_association) values (FIELD_RECORD_CONFIG_MAPS_SEQ.nextval, 47, 4, '9');
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 21, 'Team', 'TEAM',31,31,3,0,'','',64,710,1,null,1,'16');

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter,derivative_function) values  (field_configs_seq.nextval, 16, 'Team', 'TEAM',31,31,3,0,'','',64,710,1,null,1,'16');

insert into threshold_types (id,threshold_type) values (0, 'Repeat on Every Violation') ;
insert into threshold_types (id,threshold_type) values (1, 'Repeat on Full Threshold') ;
insert into threshold_types (id,threshold_type) values (2, 'Repeat once Per Period') ;
...
insert into record_configs (id, tname, description, cacheable, key, is_visible, is_partitioned, is_cost_computation_enabled, is_spark_support) values(501, 'IGNORED_ENTITIES_V','Ignored Entities', 0, '', 0, 0, 0, 0) ;

insert into record_view_configs (id, name, record_config_id, where_clause, order_by, is_pagination_enabled, is_visible,is_cell_specific, is_primary_view) values(501,'Ignored Entities', 501, '', 'IGNORED_ENTITY ASC', 1, 1, 1, 1) ;

insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format, is_expandable,ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values (field_configs_seq.nextval, 501, 'ID', 'ID', 1, 1, 8, '', 0, '', '', 20, '', 0, '', 0) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format, is_expandable,ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values (field_configs_seq.nextval, 501, 'Rule Name', 'EVENT_INSTANCE_ID', 2, 2, 1, '', 1, '', '', 256, 69, 1, 13, 1) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format, is_expandable,ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values (field_configs_seq.nextval, 501,'Ignored Entity Type','AGGREGATION_TYPE', 3, 3, 3, '', 0, '', '', 20, 528, 1,1, 1) ;
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, format, is_expandable,ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values (field_configs_seq.nextval, 501,'Ignored Entity','IGNORED_ENTITY', 4, 4, 3, '', 0, '', '', 20, null, 1,10, 1) ;

-----Threshold_value Configuration for cumulative duration-------------
insert into configurations(id, config_key, value) values(configurations_seq.nextval, 'THRESHOLD_VALUE_DURATION_EXCEEDS_IN', 'DEFAULT' );

-----Case management-------------
insert into configurations(id, config_key, value) values(configurations_seq.nextval, 'CASE_MANAGEMENT', 'DEFAULT');
