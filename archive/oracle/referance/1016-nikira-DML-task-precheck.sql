...
----- Manual Precheck -- 
insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM, IMAGE_SRC ) values (22, '0,3,4', GetParentID('Tasks'), 'Manual Precheck', '/manual_precheck/index', 0, 1, 'icons/manualprecheck.png') ;
...
-- Password Configuration logs
insert into audit_log_event_codes values (907, 'Password Configuration', 'Password Configuration was changed',  12) ;

-- Export Impot related event codes
