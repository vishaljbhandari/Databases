...
insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) values ( tasks_seq.nextval, '0,4', GetParentID('Alarm Archive View'), 'MLH View', '/alarm_stack/mlh_view/19', 0, 0) ;
