...
insert into record_configs (id, tname, description, cacheable, key, is_visible) values(100,'SCHEDULDED_JOB_EXEC_DT','Scheduler Audit Log',0,'ID',0) ;
...
insert into field_configs(id, record_config_id, name, database_field, field_id, position, data_type, is_expandable, ds_category, query_field, width, translation_id, is_visible, reg_exp_id, is_filter) values  (field_configs_seq.nextval, 100, 'Job Name', 'JOB_NAME',2,0,3,0,'','',40,null,1,0,1) ;
...
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(basic_filter_configs_seq.nextval, 100, 121, 2, 0, 2, 0) ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(basic_filter_configs_seq.nextval, 100, 121, 5, 10, 5, 0) ;
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(basic_filter_configs_seq.nextval, 100, 121, 6, 10, 6, 0) ;
