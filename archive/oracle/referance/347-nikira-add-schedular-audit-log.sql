...
BEGIN
	...
	insert into tasks (ID, PACKAGE_IDS, PARENT_ID, NAME, LINK, IS_DEFAULT, IS_MENU_ITEM ) (select tasks_seq.nextval, '0,1,2,3,4', parentid, name, '/record_view/list/' || id ||'',0 , 1 from record_view_configs where  id =121);
...
insert into basic_filter_configs(id, record_config_id, record_view_config_id, field_id, operator_id, position, is_mandatory) values(BASIC_FILTER_SEQ.nextval, 100, 121, 2, 0, 2, 0) ;
