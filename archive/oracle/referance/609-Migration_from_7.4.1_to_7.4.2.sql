...
insert into configurations(id, config_key, value) values(configurations_seq.nextval,'RTF.OFFLINE.TEST_RUN_PROCESSOR_URL','TCP://[127.0.0.1]:22000') ;
insert into configurations(id, config_key, value) values(configurations_seq.nextval,'RTF.OFFLINE.TEST_RUN_PROCESSOR_ADDITIONAL_PARAMS','-w TCP://[127.0.0.1]:20000 -c "20:TCP://[127.0.0.1]:50020 22:TCP://[127.0.0.1]:50022" -s TCP://[127.0.0.1]:20003 -R TCP://[127.0.0.1]:21000 -l TCP://[127.0.0.1]:91090 -F 2 -C 4 -k NO -P') ;
...
insert into configurations(id, config_key, value) values(configurations_seq.nextval,'RTF.ONDEMAND.TEST_RUN_PROCESSOR_URL','TCP://[127.0.0.1]:22001') ;
insert into configurations(id, config_key, value) values(configurations_seq.nextval,'RTF.ONDEMAND.TEST_RUN_PROCESSOR_ADDITIONAL_PARAMS','-w TCP://[127.0.0.1]:20000 -c "20:TCP://[127.0.0.1]:50020 22:TCP://[127.0.0.1]:50022" -s TCP://[127.0.0.1]:20003 -R TCP://[127.0.0.1]:21000 -l TCP://[127.0.0.1]:91091 -F 2 -C 4 -k NO -P') ;
...
update field_categories set category= 'ACCUMULATION_FIELD AGGREGATION_TYPE NEGATIVE_RULE_AGG_TYPE NICKNAME HOTLIST MANUAL_ALARM PROFILE_SPECIFIC ONDEMAND_OFFLINE_TEST STATS_RULE_AGG_TYPE' ,  regular_expression_id = 8 , data_type = 3 where id = 225 and name = 'User Name' ;
...
--** ISP is enabled 
insert into agg_type_pseudo_functions values ( AGG_TYPE_PSEUDO_FUNCTIONS_seq.nextval, 225, 50 ) ;
insert into pseudo_functns_record_configs values(50, 83);
...
insert into configurations values(configurations_seq.nextval, 'INLINE_IRM_LISTEN_URL','TCP://[127.0.0.1]:51001',1) ;
...
insert into configurations(id, config_key, value) values(configurations_seq.nextval, 'NOTIFICATION_MANAGER_HOST', '127.0.0.1');

delete from configurations where config_key = 'ACTIVITY_EXECUTOR_HOST' ;
insert into configurations(id, config_key, value) values(configurations_seq.nextval, 'ACTIVITY_EXECUTOR_HOST', '127.0.0.1');
...
insert into configurations(id, config_key, value) values(configurations_seq.nextval, 'DEFAULT_LOCAL_HOST', '127.0.0.1');
