...
insert into configurations(id, config_key, value) values(configurations_seq.nextval,'STATS_RULE.DEFAULT_ELEMENT_DURATION', '2592000') ;

insert into statistic_functions(id, name) values(1, 'Average') ;
insert into statistic_functions(id, name) values(2, 'Minimum') ;
insert into statistic_functions(id, name) values(3, 'Maximum') ;
