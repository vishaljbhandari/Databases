...
delete from rule_creation_record_configs where record_config_id = 96 ;
...
insert into field_categories(id, name, category, data_type,regular_expression_id,common_category_id,maskable_positions,is_maskable) values( 5001, 'Account Name', 'AGGREGATION_TYPE NICKNAME HOTLIST MANUAL_ALARM_AGGREGATION_TYPE', 3,'8', '5001', '' , '' );

insert into aggregation_types_maps ( id, source_aggregation, dest_aggregation, field_category_id, group_record_config_id) values ( 14, 5001, 0, 203, 4);
...
insert into rule_creation_record_configs(ID,RECORD_CONFIG_ID,TASK_ID,CATEGORY) values (17, 96, GetParentID('NetFlow Rule Creation'), 'RULE') ;
insert into rule_creation_record_configs(ID,RECORD_CONFIG_ID,TASK_ID,CATEGORY) values (18, 96, GetParentID('NetFlow Template Creation'), 'TEMPLATE') ;
...
insert into alarm_status_action_maps(id, status, analyst_action_id, reference_type) select alarm_status_action_maps_seq.nextval, status, analyst_action_id, 7 from alarm_status_action_maps where reference_type = 3 ;
